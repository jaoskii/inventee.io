<?php
use yii\helpers\Url;
$this->title = 'Supplier Price Change';
...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
              ...
              <div class="box-body">
                ...
                <!-- WAREHOUSE -->
                <h6 class="aimslabel whcodeview hidden " style="display:none;"><b>Warehouse :</b>
                ...
                <h6 class="aimslabel whcodelookup hidden" style="display:none;"><b>Warehouse :</b>
                <div class="input-group">
                ...
                <h6 class="aimslabel hidden" style="display:none;"><b>Due Date :</b>
                ...
                <h6 class="aimslabel effectivedatelookup" style="display:none;"><b>Effective Date :<div data-date-viewmode="days" data-date-format="yyyy-mm-dd" data-date="<?php date('Y-m-d');?>"  class="paedit input-group date dpYears">
                  <input type="text" name = "effectdate" readonly="" value="<?php if(isset($moduledata)){echo $moduledata['head']['effectivedate'];}?>" size="12" class="moduletxt txteffectivedate form-control input-sm" disabled="true">
                  <div class="dateid-lookup input-group-addon add-on"><a href="#"><i class="fa fa-chevron-circle-down"></i></a></div>
                </div></b></h6>

                <h6 class="aimslabel effectivedateview"><b>Effective Date :</b>
                <input disabled="true" name="effectdateview" value ="<?php if(isset($moduledata)){echo $moduledata['head']['effectivedate'];}?>" type="text" class="moduletxt txteffectivedateview form-control input-sm"></h6>
                <!-- DATE -->
                ...
                <h6 class="aimslabel termsview hidden" style="display:none;"><b>Terms: <input name="termview" value="<?php if(isset($moduledata)){echo $moduledata['head']['terms'];}?>" type="text" disabled=true class="txttermsview moduletxt form-control input-sm"></b></h6>

                <h6 class="aimslabel termslookup hidden" style="display:none;"><b>Terms :</b>
                <div class="input-group">
                ...
                <h6 class="aimslabel hidden"><b>Forex: </br>
