              ...
              ?>
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    <?php
                      if(!$moduledata['head']['isposted']){
                        echo '<button type="button" class="btn btn-default btn-success headbtn btnactive module-btnprint"><b><i class="fa fa-print print_btn"></i> Print</b></button>';
                      }else{
                        echo '<button style="display:none;" type="button" class="btn btn-default btn-success headbtn btnactive module-btnprint"><b><i class="fa fa-print print_btn"></i> Print</b></button>';
                      }//end if
                    ?>
