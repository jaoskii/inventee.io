   ...
   <!-- ADD CLASS (pop-btn btn-xx ) to BUTTONS added here also Remove button captions -->  
    ...
    <button type="button" data-toggle="tooltip" title="New transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> </b></button><div class="list">New</div>
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save Stock Items</div>
                      <button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnadd" disabled="true"><b><i class="fa fa-plus add_btn"></i> </b></button><div class="list">Add Item</div>
                      <button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnquickadd" disabled="true"><b><i class="fa fa-bolt quickadd_btn"></i> </b></button><div class="list">Quick Add</div>
                       <button  disabled="true" style="display:none;" type="button" class="orderbtns pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> </b></button><div class="list">PR</div>';
                    }else{
                      echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save Stock Items</div>
                      <button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnadd"><b><i class="fa fa-plus add_btn"></i> </b></button><div class="list">Add Item</div>
                      <button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnquickadd"><b><i class="fa fa-bolt quickadd_btn"></i> </b></button><div class="list">Quick Add</div>
                       <button style="display:none;" type="button" class="orderbtns pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> </b></button><div class="list">PR</div>';
                    }
                    ?>
...
<div class="col-md-12">
      <div class="box box-solid box-success">
                  ...
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      <button type="button" class="btn btn-default btn-success stockbtn stock-btnquickadd" disabled="true"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>
                       <button  disabled="true" style="display:none;" type="button" class="orderbtns btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> PR</b></button>';
                    }else{
                      echo'<button type="button" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save Stock Items</b></button>
                      ...
                      <button type="button" class="btn btn-default btn-success stockbtn stock-btnquickadd"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>
                       <button style="display:none;" type="button" class="orderbtns btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> PR</b></button>';
                    }
                    ?>
              ...
              <div class="box-body">
                ...
                <h6 style="display:none;" class="aimslabel"><b>Cost Center:  
                <div class="input-group">
