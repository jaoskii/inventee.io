...
namespace backend\modules\tphandling\controllers;
...
class DefaultController extends Controller
{
            ...
            'column' => [
                [
                   'name' => 'docno',
                    ...
                    'label' => 'Handling Fee',
                    'type' => 'text',
                    'class' => 'col-min stocktxt txthandlingfee'
                ],[
                    'name' => 'cutoff',
                    'editable' => true,
                    'default' => '',
    ...
    public function actionPulldata(){
     try {
      ...
      $primarydata = Yii::$app->backend->pullHeaderhandling($trno);
      ...
      $moduledata['handlingfee']=$primarydata[0]['handlingfee'];
