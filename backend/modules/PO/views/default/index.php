...
<?php
  ...
  echo'<button type="button" class="pop-btn btn-xx headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i></b></button>
    ...
    if($moduledata['head']['islocked']){
    echo'<button type="button" class="pop-btn btn-xx headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
        <div class="list">Unpost</div>
        <button type="button" class="pop-btn btn-xx headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
        <div class="list">Unpost</div>
        <button type="button" class="pop-btn btn-xx headbtn btnactive module-btnunlock btn btn-default btn-success" style="display:block;"><b><i class="fa fa-unlock unlock_btn"></i> Unlock</b></button>
        <div class="list">Unpost</div>';
    }else{
...
if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
  ...
  switch (Yii::$app->systemsettings->companyConfig()) {
    ...
    default:
      echo '<button style="display:none;" disabled="true" type="button" class="pop-btn btn-xx orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i></b></button>
            <div class="list">PR</div>';
    break;
  }//end switch
  ...
  switch (Yii::$app->systemsettings->companyConfig()) {
    ...
    default:
      echo '<button style="display:none;" type="button" class="pop-btn btn-xx orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i></b></button>
      <div class="list">PR</div>';
    break;
  }//end switch
}
...
<button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnadd" disabled="true"><b><i class="fa fa-plus add_btn"></i></b></button>
<div class="list">Add Item</div>
<button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnquickadd" disabled="true"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>
<div class="list">Quickadd Item</div>';
...
echo '<button disabled="true" id ="'.$moduleid.'-btnnavfirst" type="button" class="pop-btn btn-xx btn-navs btn btn-default btn-success btn-navfirst"><b><i class="fa fa-fast-backward page_nav_icons"></i></b></button>
<div class="list">First</div>
                  ...
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                          ...
                          default:
                            echo '<button style="display:none;" disabled="true" type="button" class="orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> PR</b></button>';
                          break;
                      }//end switch
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                            ...
                            default:
                              echo '<button style="display:none;" type="button" class="orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> PR</b></button>';
                            break;
                        }//end switch
                      }
                    ?>
