...
?>
  ...
  <center>    
    <h4><b>Log In to Begin</b></h4>
  </center>


<input type = "hidden" id ="viewmoduleid" value="adminsignin">
                <input type="text" placeholder = "Enter Username" class="form-control" id="dashusername" value="<?php if(isset($userwithoutcenter)){echo $userwithoutcenter;}?>">           
                ...
                <button class="btndashin btn btn-lg btn-success btn-block">Go</button>
                <br/>                <br/>
                 <h5 style="text-align: center;">© RT Trading Software 2016</h5>

                <label style="display: none;" ><?php echo Yii::$app->session['sysconfig']['login_info']; ?></label>
                <h6 style="display: none;" class="aimslabel">Best viewed on <a href="https://www.mozilla.org/en-US/firefox/new/">Mozilla Firefox</a> and <a href="https://www.google.co.in/chrome/browser/desktop/">Google Chrome</a></h6>
