<?php
use yii\helpers\Url;
$this->title = 'Stock Transfer Request';
    ...
    <button type="button" data-toggle="tooltip" title="New transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> </b></button><div class="list">New</div>
                    ...
                    <?php
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
                        ...
                        if($moduledata['head']['yourref'] ==""){
                          //echo '<button type="button" data-toggle="tooltip" title="Adjust" class="headbtn btnactive module-adjust pop-btn btn-xx btn btn-default btn-success" style="display:block;"><b><i class="fa fa-retweet adjust_btn"></i> Adjust</b></button><div class="list">CAPTION</div>';
                        }else{
                          //echo '<button type="button" data-toggle="tooltip" title="Adjust" class="headbtn module-adjust pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-retweet adjust_btn"></i> Adjust</b></button><div class="list">CAPTION</div>';
                        }
                         echo '<button type="button" data-toggle="tooltip" title="Post Transaction" class="headbtn module-btnpost pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check post_btn"></i> </b></button><div class="list">Post</div>';
                      }else{
                        if($moduledata['head']['islocked']){
                        echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
                        <button type="button" data-toggle="tooltip" title="Lock Transaction" class="headbtn module-btnlock pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> </b></button><div class="list">Lock</div>
                  ...
                  <div class="btn-group">
                    ...
                    <?php
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                        ...
                        if($moduledata['head']['yourref'] ==""){
                          //echo '<button type="button" data-toggle="tooltip" title="Adjust" class="headbtn btnactive module-adjust btn btn-default btn-success" style="display:block;"><b><i class="fa fa-retweet adjust_btn"></i> Adjust</b></button>';
                        }else{
                          //echo '<button type="button" data-toggle="tooltip" title="Adjust" class="headbtn module-adjust btn btn-default btn-success" style="display:none;"><b><i class="fa fa-retweet adjust_btn"></i> Adjust</b></button>';
                        }
                         echo '<button type="button" data-toggle="tooltip" title="Post Transaction" class="headbtn module-btnpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check post_btn"></i> Post</b></button>';
                      }else{
                        if($moduledata['head']['islocked']){
                        echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                        <button type="button" data-toggle="tooltip" title="Lock Transaction" class="headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
                  ...
                  switch (Yii::$app->systemsettings->companyConfig()) {
                    case 'SOUTHCENTRAL':
                      echo'<h6 class="agentlookup" style="display: none;"><b>Agent:  
                              <div class="input-group">
                                  <input id = "clientagentcode" name = "agentcode" readonly="true" value ="';
                                  if(isset($moduledata)){
                                    echo $moduledata['head']['agent'];
                                  }//end if moduledata
                                  echo '" type="text" class="moduletxt txtagentcode input-sm form-control" disabled="true"><div class="frmdocumentno input-group-addon"><a class ="agentlookup" href="#"><i class="fa fa-chevron-circle-down" ></i></a></div>
                              </div>
                          </h6>';
                      ...
                      echo '" type="text" class="moduletxt agentlookupview2 input-sm form-control" disabled="true"></b></h6>';                      
                    break;
                  }//END SWITCH CASE
                ?>
                </div><!-- /.col -->
