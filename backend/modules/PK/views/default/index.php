<?php
use yii\helpers\Url;
$this->title = 'Production Completion';
?>
...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      <button style="display:none;" disabled="true" type="button"  data-toggle="tooltip" title="PD" class="orderbtns btn btn-default btn-success stockbtn 
                      stock-btnPD"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> PD</b></button>';
                      ...
                      <button style="display:none;" type="button"  data-toggle="tooltip" title="PD" class="orderbtns btn btn-default btn-success stockbtn 
                      stock-btnPD"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> PD</b></button>';
                    }
                    ?>
                  ...
                  <?php }else{
                    ...
                    <button style="margin-top:3px;display:none;" class="btn btn-box-tool module-btnheadcollapse headediting" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button style="display:none;" disabled="true" type="button"  data-toggle="tooltip" title="PD" class="orderbtns btn btn-default btn-success stockbtn 
                      stock-btnPD"><b><i class="fa fa-arrow-circle-o-down"></i> PD</b></button>
              ...
              <div class="box-body">
                ...
                <!-- <h6 class="productioninstrutioncobj aimslabel"><b>PD #: <div class="input-group">
                    <input readonly="true" name = "prodinstruct" value =""  type="text" class="moduletxt txtourref form-control input-sm" disabled="true"></b>
                    <div class="input-group-addon"><a style="display:none;" class ="prodorderbtn prodorderlookup" href="#">
                              ...
                              <thead>
                               ...
                               if(isset($moduledata['body']) && $moduledata['body'] != ""){
                                  foreach ($moduledata['body'] as $itmindex => $itmdata) {
                                    ...
                                    <td id="stockbuttons-'.$itmdata['line'].'" style="margin-bottom:-5px;" class="origdata btnstockopt col-min aimslabelstock">';
                                    ...
                                    <td id="stockrrqty-'.$itmdata['line'].'" class="origdata col-quantity aimslabelstock">'.number_format($itmdata['rrqty'],Yii::$app->systemsettings->setDecimaldisplay('quantity')).'</td>
