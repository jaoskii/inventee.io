...
//THESE ACCESS ARRAY IS USED TO DETERMINE ACCESS INDEX ON ATTRIBUTES
	public $access = array(
        ...
        'changeamount' => 161,'changedisc'=>3302,
        'crlimit'=>162,'post' => 163,'unpost' => 164,
   ...
   //LOADS LAST DOCUMENT
    ...
    public function actionPulldata(){
      ...
      switch (Yii::$app->systemsettings->companyConfig()) {
        ...
        Yii::$app->response->format = Response::FORMAT_JSON;
        return ['sbcerror' => 1,'stacktrace'=>$e];
   ...
   //FOR COMPUTATION OF STOCK
    ...
    public function actionGetflaginfo(){
      try {
        ...
        Yii::$app->response->format = Response::FORMAT_JSON;
        return ['hasinfo'=>$hasfinfo,'flaginfo'=>$data];
    ...
    public function actionBuildstockview(){
      ...
      return Yii::$app->automator->generateSOStockview($sql,$type);
    }//end function
    ...
    public function actionAgentpickerlookupsearch() {
      Yii::$app->backend->AjaxVerification($this);
      $params = $_POST;
      $params['controller'] = $this;
      return Yii::$app->automator->automateAgentpickerlookup($params);
    }

    public function actionAgentcheckerlookupsearch() {
      Yii::$app->backend->AjaxVerification($this);
      $params = $_POST;
      $params['controller'] = $this;
      return Yii::$app->automator->automateAgentcheckerlookup($params);
    }
