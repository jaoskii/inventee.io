    ...
    <button type="button" data-toggle="tooltip" title="New transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> </b></button><div class="list">New</div>
                    ...
                    <?php
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
                        ...
                        <button type="button" data-toggle="tooltip" title="Post Transaction" class="headbtn module-btnpost pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check check_btn"></i> </b></button><div class="list">Post</div>';
                      }else{
                        if($moduledata['head']['islocked']){
                        echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
                        <button type="button" data-toggle="tooltip" title="Lock Transaction" class="headbtn module-btnlock pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> </b></button><div class="list">Lock</div>
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Unpost Transaction" class="headbtn module-btnunpost pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unpost_btn"></i> </b></button><div class="list">Unpost</div>
...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
                  ...
                  <div class="btn-group">
                    ...
                    <?php
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                        ...
                        <button type="button" data-toggle="tooltip" title="Post Transaction" class="headbtn module-btnpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check check_btn"></i> Post</b></button>';
                      }else{
                        if($moduledata['head']['islocked']){
                        echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                        <button type="button" data-toggle="tooltip" title="Lock Transaction" class="headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Unpost Transaction" class="headbtn module-btnunpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unpost_btn"></i> Unpost</b></button>
              ...
              <div class="box-body">
                ...
                switch (Yii::$app->systemsettings->companyConfig()) {
                  case 'KINGGEORGE':
                  echo '<h6 class="aimslabel termsview"><b>Terms: 
                  <input name="termview" value="';
                  if(isset($moduledata)){echo $moduledata['head']['terms'];}

                  echo '" type="text" disabled=true class="txttermsview moduletxt form-control input-sm"></b></h6>';

                  echo '<h6 class="aimslabel termslookup" style="display:none;"><b>Terms :</b>
                    <div class="input-group">
                    <input readonly="" name="terms" value="';
                    if(isset($moduledata)){echo $moduledata['head']['terms'];}
                  echo '" type="text" class="moduletxt txtterms form-control input-sm">
                  ...
                  echo '<div class="frmdocumentno input-group-addon"><a class ="agentlookup" href="#"><i class="fa fa-chevron-circle-down" ></i></a></div>
                    </div>
                  </h6>';

                  echo '<h6 class="agentlookupview"><b>Agent: <input name="agentcodeview" value ="';
                  if(isset($moduledata)){echo $moduledata['head']['agentcode'];}
                  echo '" type="text" class="moduletxt txtagentcodeview input-sm form-control" disabled="true"></b></h6>';
                  break;
                }//end switch
                ?>
