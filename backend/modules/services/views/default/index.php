...
if (PHP_VERSION_ID >= 80000) {
    ...
    echo "SOAP services (NuSOAP) are isolated on PHP 8+. "
        . "NuSOAP still uses PHP4-style constructors. "
        . "See UPGRADE-PHP8.md. Endpoint disabled until a full NuSOAP PHP 8 port or SoapClient rewrite.";
    return;
}
