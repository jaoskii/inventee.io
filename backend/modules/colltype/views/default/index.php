<?php
$this->title = 'Collection Type Setup';
?>
<div class="row">
  ...
  <div class="col-md-12">
    <div class="box box-solid box-success">
      <div class="modulehead box-header with-border">
        <div class="btn-group">
          <button type="button" class="btn btn-default btn-success headbtn btnactive module-btnnewcolltype">
          <b><i class="new_btn fa fa-file"></i> New</b></button>
        </div>
      </div>
      <div class="box-body scroll-divs">
        <div class="colltypegrid"></div>
