    ...
    <div class="col-md-4">
        <div class="box box-solid box-success">
              <div class="modulehead box-header with-border">
                ...
                <div class="pull-right">
                  <div class="btn-group">
                    <button style="display: none;"  type="button" class="btn btn-default btn-headlogs btn-success headbtn btnactive module-btnlogs"><b><i class="fa fa-list logs_btn"></i> Logs</b></button>
        ...
        <div class="box box-solid box-success">
              <div class="modulehead box-header with-border">
                  ...
                  <div class="pull-right">
                  <div class="btn-group">
                    <button style="display: none;" type="button" data-toggle="tooltip" title="Add Users" class="btn btn-default btn-success headbtn btnactive module-btnadduseraccess"><b><i class="fa fa-plus add_btn"></i> Add User</b></button>
                    <button style="display: none;" type="button" data-toggle="tooltip" title="Add Users" class="btn btn-default btn-success headbtn btnactive module-btnuseraccessremovegrp"><b><i class="fa fa-trash delete_btn"></i> Remove Group</b></button>
                    <button style="display: none;" type="button" data-toggle="tooltip" title="Add Users" class="btn btn-default btn-success headbtn btnactive module-btnuseraccesssaveuser"><b><i class="fa fa-save save_btn"></i> Save User</b></button>
                    <button style="display:none;" type="button" data-toggle="tooltip" title="Add Users" class="btn btn-default btn-success headbtn btnactive module-btnuseraccesscanceluser"><b><i class="fa fa-times cancel_btn"></i> Cancel</b></button>
                  </div>
                  </div><!-- /.box-tools -->
              </div><!-- /.box-header -->
              
              <div class="box-body mod-tble userlist">
                  <table class="bodytable table tableSection table-fixed">
                      ...
                      <tbody class="users-modulebody">
                      </tbody>
                  </table>        
              </div><!-- /.box-body -->

              <div class="box-body mod-tble modifyuser" style="display:none;height:50%;">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <h6 class="aimslabel" <?php echo $styler; ?>><b>Supplier Code:  
                  <div class="input-group">
                      <input name = "suppname" value ="" id="suppname" type="text" readonly class="moduletxt txtuseraccessclient input-sm form-control">
                      <div class="useraccessclientlookup input-group-addon">
                ...
                <div class="col-md-12">
                  <div class="userpicbox">
                    <img style="margin-left:30%;margin-top:5px;width:130px"; src ="" width="130px" height ="120px" class="thumbnail recordpicture">
...
*/     scroll-behavior: auto;
      ...
      <div class="col-md-8">
            <div class="box box-solid box-success">
                  ...
                  <div class="btn-group">
                    <button style="display:none;" type="button" class="btn btn-default btn-success headbtn btnactive module-btneditaccess"><b><i class="fa fa-pencil"></i> Edit Access</b></button>
                    <button style="display:none;" type="button" class="btn btn-default btn-success headbtn btnactive module-btnfinishaccess"><b><i class="fa fa-check"></i> Finish Editing</b></button>
                  </div>
                  </div><!-- /.box-tools -->
                  </div>
                  <div class="box-body scroll-divs x" id="accesslisting">
                  <div class="col-md-6">
