...
<button type="button" data-toggle="tooltip" title="New transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> </b></button><div class="list">New</div>
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                       echo'<button disabled="true" type="button" data-toggle="tooltip" title="Save all detail Entries" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save all detail Entries</div>
                    ...
                    <button disabled="true" style="display:none;" type="button"  data-toggle="tooltip" title="Unpaid" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid</div>';
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Save all detail Entries" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save all detail Entries</div>
                  ...
                  <?php }else{
                   ...
                   <button disabled="true" type="button" data-toggle="tooltip" title="Save all detail Entries" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save all detail Entries</div>
                      <button disabled="true" type="button"  data-toggle="tooltip" title="Add Entries" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnaddentries"><b><i class="fa fa-plus add_btn"></i> </b></button><div class="list">Add Entries</div>
                      <button disabled="true" style="display:none;" type="button" data-toggle="tooltip" title="Unpaid" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid</div>
              ...
              ?>
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    <?php 
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                       echo'<button disabled="true" type="button" data-toggle="tooltip" title="Save all detail Entries" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> ave all detail Entries</b></button>
                    ...
                    <button disabled="true" style="display:none;" type="button"  data-toggle="tooltip" title="Unpaid" class="btn btn-default btn-success stockbtn detail-btnunpaid"><b><i class="fa fa-tags unpaid_btn"></i> Unpaid</b></button>';
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Save all detail Entries" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save all detail Entries</b></button>
                  ...
                  <?php }else{
                   ...
                   <button disabled="true" type="button" data-toggle="tooltip" title="Save all detail Entries" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save all detail Entries</b></button>
                      <button disabled="true" type="button"  data-toggle="tooltip" title="Add Entries" class="btn btn-default btn-success stockbtn detail-btnaddentries"><b><i class="fa fa-plus add_btn"></i> Add Entries</b></button>
                      <button disabled="true" style="display:none;" type="button" data-toggle="tooltip" title="Unpaid" class="btn btn-default btn-success stockbtn detail-btnunpaid"><b><i class="fa fa-tags unpaid_btn"></i> Unpaid</b></button>
...
<div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs bg-green">
              ...
              <li class="pull-right"><h6 class="txtitemcount" style="display:block;margin-top:12px;margin-right:20px;font-size:12px;font-weight: bold;">NUMBER OF ITEMS: <?php //if(isset($moduledata)){echo number_format($moduledata['head']['itemcount']);} ?></h6></li> -->
                        ...
                        <div class="box box-solid box-success">
                            ...
                            <table class="table tbl-fix bodytable table-hover">
                              ...
                              <?php
                               ...
                               //    echo'<tr id="orgrow-'.$itmdata['trno'].'-'.$itmdata['line'].'" class="orgrow">
                                  
                               //    <td id="stockbuttons-'.$itmdata['line'].'" class="origdata btnstockopt col-min aimslabelstock">';
                               //        if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                               //        echo'<button id="stockdelete-'.$itmdata['line'].'" class="stockbtn stockdeletebtn btn btn-social-icon btn-google" style="width:18px;height:18px;margin-top:-2px;" disabled="true"><i style="font-size:12px;margin-top:-8px;" class="fa fa-trash"></i></button>';
                               //        }else{
                               //        echo'<button id="stockdelete-'.$itmdata['line'].'"  data-toggle="tooltip" title="Delete Item" class="stockbtn stockdeletebtn btn btn-social-icon btn-google" style="width:18px;height:18px;margin-top:-2px;"><i style="font-size:12px;margin-top:-8px;" class="fa fa-trash"></i></button>';
                               //        }
                               //      echo '</td>
                               //        <td class="origdata aimslabelstock col-min" id="detailpostdate-'.$itmdata['line'].'">'.$itmdata['dateid'].'</td>
                               //        <td class="origdata aimslabelstock nobody" id="detailcheckno-'.$itmdata['line'].'"></td>
                               ...
                               //        <td class="origdata aimslabelstock col-codes" id="detailref-'.$itmdata['line'].'">'.$itmdata['docno'].'</td>
                               //        <td class="origdata nobody" id="detailline-'.$itmdata['line'].'">'.$itmdata['line'].'</td>
                               //        <td class="origdata nobody" id="detailtrno-'.$itmdata['line'].'">'.$itmdata['trno'].'</td>
                               //      </tr>';
                               //    }
