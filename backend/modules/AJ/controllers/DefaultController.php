...
namespace backend\modules\AJ\controllers;
...
class DefaultController extends Controller{
  ...
  public $access = array('view' => 291,'edit' => 292,'new' => 293,'save' => 294,
        'change' => 295,'delete' => 296,'print' => 297,'lock' => 298,
        'unlock' => 299,'post' => 300,'unpost' => 301,'denydetails' => 302,'changeamount'=>826,
        'clickadditem'=>823,'clickedititem'=>824,'clickdeleteitem'=>825);
...
//FOR SEARCHING FUNCTIONS ###################################################################################
  ...
  public function actionRequestdistro(){
    ...
    public function actionBuildstockview(){
        ...
        return Yii::$app->automator->generateAJStockview($sql,$type);
      }//end function

      //jly GG d5 docnolookup
