...
<?php
  ...
  echo'<button type="button" title="Delete Transaction" class="pop-btn btn-xx headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i></b></button>
    ...
    <button type="button" title="Unpost Transaction" class="pop-btn btn-xx headbtn btnactive module-btnunpost btn btn-default btn-success" style="display:block;"><b><i class="fa fa-history unpost_btn"></i></b></button>
...
if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
  echo'<button type="button" title="Save all  stock Items" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i></b></button>
  <div class="list">Save All Items</div>
  <button type="button"  title="Add New Item" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnadd" disabled="true"><b><i class="fa fa-plus add_btn"></i></b></button>
  <div class="list">Add Item</div>
  <button type="button"  title="Quick Add" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnquickadd" disabled="true"><b><i class="fa fa-bolt quickadd_btn"></i></b></button>
  <div class="list">Quickadd Item</div>';

}else{
  echo'<button type="button" title="Save all  stock Items" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i></b></button>
  <div class="list">Save All Items</div>
  <button type="button"  title="Add New Item" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnadd"><b><i class="fa fa-plus add_btn"></i></b></button>
  <div class="list">Add Item</div>
  <button type="button"  title="Quick Add" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnquickadd"><b><i class="fa fa-bolt quickadd_btn"></i></b></button>
  <div class="list">Quickadd Item</div>';
}
?>
...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      <button type="button"  title="Quick Add" class="btn btn-default  btn-success stockbtn stock-btnquickadd" disabled="true"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>';
                      ...
                      <button type="button"  title="Quick Add" class="btn btn-default  btn-success stockbtn stock-btnquickadd"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>';
                    }
                    ?>
              ...
              <div class="box-body">
                ...
                <!-- WAREHOUSE -->
                <h6 class="aimslabel hidden whcodeview"><b>Warehouse :</b>
                ...
                <h6 class="aimslabel hidden whcodelookup" style="display:none;"><b>Warehouse :</b>
                <div class="input-group">
                ...
                <h6 class="aimslabel nobody"><b>Forex: </br>
