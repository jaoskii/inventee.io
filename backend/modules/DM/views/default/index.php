...
<?php if($moduledata['head']['trno'] != null){?>
  ...
  if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
    ...
    <button style="display:none;" type="button"  disabled="true" class="orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i></b></button>
    <div class="list">RR</div>';


  }else{
    echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save Stock Items</b></button>
    <div class="list">Save All Items</div>
    <button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnadd"><b><i class="fa fa-plus add_btn"></i> Add Item</b></button>
    <div class="list">Add Item</div>
    <button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnquickadd"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>
    <div class="list">Quickadd Item</div>
    <button style="display:none;" type="button" class="orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> RR</b></button>
    <div class="list">RR</div>';
  }
  ?>
  ...
  <button type="button"  style="display:none;" class="pop-btn btn-xx btn btn-default btn-success orderbtns stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i></b></button>
  <div class="list">RR</div>
...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      <button style="display:none;" type="button"  disabled="true" class="orderbtns btn btn-default btn-success stockbtn 
                      stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> RR</b></button>';
                      ...
                      <button style="display:none;" type="button" class="orderbtns btn btn-default btn-success stockbtn 
                      stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> RR</b></button>';
                    }
                    ?>
                  ...
                  <?php }else{
                    ...
                    <button type="button" class="btn btn-default btn-success stockbtn stock-btnquickadd" disabled="true"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>
                      ...
                      <button type="button"  style="display:none;" class="btn btn-default btn-success orderbtns 
                      stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> RR</b></button>
              ...
              <div class="box-body">
                ...
                <div class="input-group">
                    <input readonly name="contra" value="<?php if(isset($moduledata)){echo $moduledata['head']['contra'];}?>" type="text" class="moduletxt txtcontra form-control input-sm">
                ...
                <div class="invoice-col col-md-3">
                <!-- <h6 class="aimslabel"><b>Invoice Date: <input disabled="true" name="shipto" value="<?php if(isset($moduledata)){echo $moduledata['head']['shipto'];}?>" type="text" class="moduletxt txtshipto form-control input-sm"></b></h6> -->
                 <h6 class="aimslabel dateidlookup" style="display:none;"><b>Invoice Date: <div data-date-viewmode="days" data-date-format="yyyy-mm-dd" data-date="<?php date('Y-m-d');?>"  class="paedit input-group date dpYears">
                  <div class="dateid-lookup input-group-addon add-on"><a href="#"><i class="fa fa-chevron-circle-down"></i></a></div>
                  <input type="text" name = "shipto" readonly="" value="<?php if(isset($moduledata)){echo $moduledata['head']['shipto'];}?>" size="12" class="moduletxt txtshipto form-control input-sm" disabled="true">
                </div></b></h6>

                <h6 class="aimslabel dateidview"><b>Invoice Date :</b>
                <input disabled="true" name="shiptoview" value ="<?php if(isset($moduledata)){echo $moduledata['head']['shipto'];}?>" type="text" class="moduletxt txtshiptoview form-control input-sm"></h6>
