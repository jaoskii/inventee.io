...
<button type="button" data-toggle="tooltip" title="New transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> </b></button><div class="list">New</div>
                    <button type="button" data-toggle="tooltip" title="Save Transaction Head" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnsave" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">CAPTION</div>
                     <?php
                    ...
                    <?php
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Delete Transaction" class="headbtn module-btndelete pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
                        ...
                        if($moduledata['head']['yourref'] ==""){
                          echo '<button type="button" data-toggle="tooltip" title="Adjust" class="headbtn btnactive module-adjust pop-btn btn-xx btn btn-default btn-success" style="display:block;"><b><i class="fa fa-retweet adjust_btn"></i> </b></button><div class="list">Adjust</div>';
                        }else{
                          echo '<button type="button" data-toggle="tooltip" title="Adjust" class="headbtn module-adjust pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-retweet adjust_btn"></i> </b></button><div class="list">Adjust</div>';
                        }
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Unpost Transaction" class="headbtn module-btnunpost pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-history unpost_btn"></i> </b></button><div class="list">Unpost</div>
                        <button type="button" data-toggle="tooltip" title="Adjust" class="headbtn module-adjust pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-retweet adjust_btn"></i> </b></button><div class="list">Adjust</div>
                  ...
                  <div class="btn-group">
                    ...
                    <?php
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Unpost Transaction" class="headbtn module-btnunpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-history unpost_btn"></i> Unpost</b></button>
                        <button type="button" data-toggle="tooltip" title="Adjust" class="headbtn module-adjust btn btn-default btn-success" style="display:none;"><b><i class="fa fa-retweet adjust_btn"></i> Adjust</b></button>
