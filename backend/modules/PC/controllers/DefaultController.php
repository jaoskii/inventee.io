...
namespace backend\modules\PC\controllers;
...
class DefaultController extends Controller{
  ...
  public $access = array('view' => 276,'edit' => 277,'new' => 278,'save' => 279,
        'change' => 280,'delete' => 281,'print' => 282,'lock' => 283,
        'unlock' => 284,'post' => 285,'unpost' => 286,'changeamount'=>838,
        'clickadditem'=>835,'clickedititem'=>836,'clickdeleteitem'=>837);
   ...
   public function actionVerifyaccess($accesstype,$trno){      
    ...
    public function actionIndex(){   
        ...
        if($return['verifyuser']==1){
          ...
          //var_dump($return['moduledata']);
          $costaccess = Yii::$app->backend->viewcostAccess();
          return $this->render('index',array('moduledata' => $return['moduledata'],'moduleid'=>$return['moduleid'],'viewcosting'=>$costaccess));
        }//
    }//END ACTION INDEX
...
//FOR SEARCHING FUNCTIONS ###################################################################################
   ...
   public function actionComparestocklines(){     
    ...
    public function actionAdjustinventory(){
        Yii::$app->backend->AjaxVerification($this);
        $params = $_GET;
        $return=Yii::$app->sbccontroller->sbcAdjustinventory($this,$params);        
        Yii::$app->response->format = Response::FORMAT_JSON;
        return ['status'=>$return['status'],'error_msg'=>$return['error_msg'],'ref'=>$return['ref']];
      //echo json_encode(array('status'=>$return['status'],'error_msg'=>$return['error_msg'],'ref'=>$return['ref']));
    }
    ...
    public function actionBuildstockview(){
      ...
      return Yii::$app->automator->generatePCStockview($sql,$type);
   }//end function

      //jly GG d3 docnolookup
