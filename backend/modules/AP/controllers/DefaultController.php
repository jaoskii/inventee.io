...
namespace backend\modules\AP\controllers;
...
class DefaultController extends Controller{
  ...
  public $access = array(
        'view' => 134 ,'edit' => 135,'new' => 136,
        'save' => 137,'change' => 138,'delete' => 139,
        'print' => 140,'lock' => 141,'unlock' => 142,
        'denyamount' => 143,'post' => 143,'unpost' => 144,
    ...
    public function actionLoadclientunpaid(){
      Yii::$app->backend->AjaxVerification($this);
        ...
        if($return['verifyuser']==1){
           ...
           Yii::$app->response->format = Response::FORMAT_JSON;
            return ['unpaidacc' => $return['unpaidacc']];
