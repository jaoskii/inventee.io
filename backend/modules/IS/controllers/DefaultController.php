...
namespace backend\modules\IS\controllers;
...
class DefaultController extends Controller{
    ...
    public $access = array('view' => 258,'edit' => 259,'new' => 260,'save' => 261,
      'change' => 262,'delete' => 263,'print' => 264,'lock' => 265,
      'unlock' => 266,'post' => 267,'unpost' => 268,'denydetails' => 269,'changeamount'=>830,
      'clickadditem'=>827,'clickedititem'=>828,'clickdeleteitem'=>829);
...
//jly GG d1 stock
    public function actionBuildstockview(){
        ...
        return Yii::$app->automator->generateISStockview($sql,$type);
   }//end function
