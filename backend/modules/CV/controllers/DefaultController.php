...
namespace backend\modules\CV\controllers;
...
class DefaultController extends Controller{
  ...
  public $access = array(
        'view' => 117 ,'edit' => 118,'new' => 119,
        'save' => 120,'change' => 121,'delete' => 122,
        'print' => 123,'lock' => 124,'unlock' => 125,
        'post' => 126,'unpost' => 127,
...
//########################################################## GJ UPDATE JAOSKI
    ...
    public function actionRetrieveattachments(){
        ...
        ifnull(attach_3,'') as attach_3,ifnull(attach_4,'') as attach_4 from sbc_cv_attachments where trno = ".$trno."";
