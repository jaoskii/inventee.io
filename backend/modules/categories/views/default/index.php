...
$this->title='Supp/Cust. Categories';

switch (Yii::$app->systemsettings->companyConfig()) {
  case 'KINGGEORGE':
    $this->title = "[" .Yii::$app->session['loggeduser']['king_branchname'] . "] Categories";
  break;
}//END IF
            ...
            <div class="col-md-12 pull-right">
                <label>Search : </label>
                  <div class="input-group">
                    <input value ="" type="text" class="txtsearchcategories2 input-sm form-control">
