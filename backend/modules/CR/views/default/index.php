     ...
     <?php
      ...
      echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="fa fa-pencil edit_btn"></i> </b></button>
        ...
        if($moduledata['head']['islocked']){
         echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="fa fa-pencil edit_btn"></i> </b></button><div class="list">Edit</div>';
        }else{
          echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnedit" style="display:block;"><b><i class="fa fa-pencil edit_btn"></i> </b></button><div class="list">Edit</div>';
        }
      }
     ?>
      <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btncancel" style="display:none;"><b><i class="fa fa-times cancel_btn"></i> </b></button><div class="list">Cancel</div>
      <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnprint"><b><i class="fa fa-print print_btn"></i> </b></button><div class="list">Print</div>
                    
      <?php
        if($moduledata['head']['isposted']){
        echo'<button type="button" class="pop-btn btn-xx headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
          <button type="button" class="pop-btn btn-xx headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> </b></button><div class="list">Lock</div>
          <button type="button" class="pop-btn btn-xx headbtn module-btnunlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unlock_btn"></i> </b></button><div class="list">Unlock</div>
          <button type="button" class="pop-btn btn-xx headbtn btnactive module-btnunpost btn btn-default btn-success" style="display:block;"><b><i class="fa fa-history unpost_btn"></i> </b></button><div class="list">Unpost</div>
          <button type="button" class="pop-btn btn-xx headbtn module-btnpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check post_btn"></i> </b></button><div class="list">Post</div>';
        }else{
          if($moduledata['head']['islocked']){
          echo'<button type="button" class="pop-btn btn-xx headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
          <button type="button" class="pop-btn btn-xx headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> </b></button><div class="list">Lock</div>
          <button type="button" class="pop-btn btn-xx headbtn btnactive module-btnunlock btn btn-default btn-success" style="display:block;"><b><i class="fa fa-unlock unlock_btn"></i> </b></button><div class="list">Unlock</div>';
          }else{
          echo'<button type="button" class="pop-btn btn-xx headbtn btnactive module-btndelete btn btn-default btn-success"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
          <button type="button" class="pop-btn btn-xx headbtn btnactive module-btnlock btn btn-default btn-success" style="display:block;"><b><i class="fa fa-lock lock_btn"></i> </b></button><div class="list">Lock</div>
          <button type="button" class="pop-btn btn-xx headbtn module-btnunlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unlock_btn"></i> </b></button><div class="list">Unlock</div>';
          }
        echo'<button type="button" class="pop-btn btn-xx headbtn module-btnunpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-history unpost_btn"></i> </b></button><div class="list">Unpost</div>
          <button type="button" class="pop-btn btn-xx headbtn btnactive module-btnpost btn btn-default btn-success" style="display:block;"><b><i class="fa fa-check post_btn"></i> </b></button><div class="list">Post</div>';
        }
       ?>

                     <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnlogs"><b><i class="fa fa-list logs_btn"></i> </b></button><div class="list">Logs</div>

                    <?php 
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                       echo'<button disabled="true" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detailsaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i></b></button><div class="list"> Save all detail Entries</div>
                      <button disabled="true" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnaddentries"><b><i class="fa fa-plus add_btn"></i> </b></button><div class="list">Add Entries</div>
                      <button disabled="true" style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btncoalookup"><b><i class="fa fa-list-alt coa_btn"></i> </b></button><div class="list">Add COA</div>
                      <button disabled="true" style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid</div>';
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                        ...
                        default:
                          echo '<button disabled="true" style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid2"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid 2</div>
                                <button disabled="true" style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnpdcchecks"><b><i class="fa fa-tags checks_btn"></i></b></button><div class="list">PDC</div>';
                        break;
                      }//END SWITCH
                    }else{
                      echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detailsaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i></b></button><div class="list"> Save all detail Entries</div>
                      <button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnaddentries"><b><i class="fa fa-plus add_btn"></i> </b></button><div class="list">Add Entries</div>
                      <button style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btncoalookup"><b><i class="fa fa-list-alt coa_btn"></i> </b></button><div class="list">Add COA</div>
                      <button style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid</div>';
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                        ...
                        default:
                          echo '<button style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid2"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid 2</div>
                                <button style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnpdcchecks"><b><i class="fa fa-tags checks_btn"></i></b></button><div class="list">PDC</div>';
                        break;
                      }//END SWITCH
                    }
                    ?>
                  ...
                  <?php }else{
                    ...
                    <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> </b></button><div class="list">New</div>
                    <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnsave" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save</div>
                    <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="fa fa-pencil edit_btn"></i> </b></button><div class="list">Edit</div>
                    <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btncancel" style="display:none;"><b><i class="fa fa-times cancel_btn"></i> </b></button><div class="list">Cancel</div>
                    <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnprint" style="display:none;"><b><i class="fa fa-print print_btn"></i> </b></button><div class="list">Print</div>
                    <button type="button" class="pop-btn btn-xx headbtn module-btndelete pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> </b></button><div class="list">Delete</div>
                    <button type="button" class="pop-btn btn-xx headbtn module-btnlock pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> </b></button><div class="list">Lock</div>
                    <button type="button" class="pop-btn btn-xx headbtn module-btnunlock pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unlock_btn"></i> </b></button><div class="list">Unlock</div>
                    <button type="button" class="pop-btn btn-xx headbtn module-btnunpost pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-history unpost_btn"></i> </b></button><div class="list">Unpost</div>
                    <button type="button" class="pop-btn btn-xx headbtn btnactive module-btnpost pop-btn btn-xx btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check post_btn"></i> </b></button><div class="list">Post</div>
                    <button type="button" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnlogs" style="display:none;"><b><i class="fa fa-list logs_btn"></i> </b></button><div class="list">Logs</div>
                    <button disabled="true" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detailsaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i></b></button><div class="list"> Save all detail Entries</div>
                    <button disabled="true" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnaddentries"><b><i class="fa fa-plus add_btn"></i> </b></button><div class="list">Add Entries</div>
                    <button disabled="true" style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btncoalookup"><b><i class="fa fa-list-alt coa_btn"></i> </b></button><div class="list">Add COA</div>
                    <button disabled="true" style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid</div>';
                    switch (Yii::$app->systemsettings->companyConfig()) {
                        ...
                        default:
                          echo '<button disabled="true" style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnunpaid2"><b><i class="fa fa-tags unpaid_btn"></i> </b></button><div class="list">Unpaid 2</div>
                                <button style="display:none;" type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn detail-btnpdcchecks"><b><i class="fa fa-tags checks_btn"></i>PDC</b></button><div class="list">PDC</div>';
                        break;
                    }//END SWITCH
                     
                    echo '<button disabled="true" id ="'.$moduleid.'-btnnavfirst" type="button" class="pop-btn btn-xx btn-navs pop-btn btn-xx btn btn-default btn-success btn-navfirst"><b><i class="fa fa-fast-backward page_nav_icons"></i></b></button>
                    <button disabled="true" id ="'.$moduleid.'-btn-navprev"  type="button" class="pop-btn btn-xx btn-navs pop-btn btn-xx btn btn-default btn-success btn-navprev"><b><i class="fa fa-backward page_nav_icons"></i></b></button>
                    <button disabled="true" id ="'.$moduleid.'-btnnavnext"  type="button" class="pop-btn btn-xx btn-navs pop-btn btn-xx btn btn-default btn-success btn-navnext"><b><i class="fa fa-forward page_nav_icons"></i></b></button>
                    <button disabled="true" id ="'.$moduleid.'-btnnavlast" type="button" class="pop-btn btn-xx btn-navs pop-btn btn-xx btn btn-default btn-success btn-navlast"><b><i class="fa fa-fast-forward page_nav_icons"></i></b></button>
                    <button style="margin-top:3px;display:none;" class="pop-btn btn-xx btn btn-box-tool module-btnheadcollapse headediting" data-widget="collapse"><i class="fa fa-minus"></i></button>
...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
              ...
              ?>
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                          ...
                          default:
                            echo '<button disabled="true" style="display:none;" type="button" data-toggle="tooltip" title="Unpaid 2" class="btn btn-default btn-success stockbtn detail-btnunpaid2"><b><i class="fa fa-tags unpaid_btn"></i> Unpaid 2</b></button>
                                  <button disabled="true" style="display:none;" type="button" data-toggle="tooltip" title="Checks" class="btn btn-default btn-success stockbtn detail-btnpdcchecks"><b><i class="fa fa-tags checks_btn"></i>PDC</b></button>';
                          break;
                      }//END SWITCH
                    }else{
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                          ...
                          default:
                            echo '<button style="display:none;" type="button"  data-toggle="tooltip" title="Unpaid 2" class="btn btn-default btn-success stockbtn detail-btnunpaid2"><b><i class="fa fa-tags unpaid_btn"></i> Unpaid 2</b></button>
                                  <button style="display:none;" type="button" data-toggle="tooltip" title="PDC" class="btn btn-default btn-success stockbtn detail-btnpdcchecks"><b><i class="fa fa-tags checks_btn"></i>PDC</b></button>';
                          break;
                      }//END SWITCH
                    }
                    ?>
                  ...
                  <?php }else{
                    ...
                    echo '<button disabled="true" id ="'.$moduleid.'-btnnavfirst" type="button" class="btn-navs btn btn-default btn-success btn-navfirst"><b><i class="fa fa-fast-backward page_nav_icons"></i></b></button>
              ...
              <div class="box-body">
                ...
                switch (Yii::$app->systemsettings->companyConfig()) {
                    case 'SOUTHCENTRAL':
                    echo '<h6 class="aimslabel"><b>Agent: <input name="agentcode" value ="';
                    if(isset($moduledata)){echo $moduledata['head']['agentcode'];
                    }
                    echo'" type="text" class="txtagentcode form-control input-sm" disabled="true"></b></h6>';
                    break;
                }//ends witch
                ?>
                        ...
                        <div class="box box-solid box-success">
                            ...
                            <table class="table tbl-fix bodytable table-hover">
                              ...
                              <?php
                               ...
                               //        <td class="origdata nobody" id="detailpdcline-'.$itmdata['line'].'">'.$itmdata['pdcline'].'</td>
                               //      </tr>';
                               //    }
