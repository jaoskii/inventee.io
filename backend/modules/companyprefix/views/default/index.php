...
<div class="col-md-12">
      <div class="box box-solid box-success">
            ...
            <div class="box-body">
                ...
                <div class="invoice-col col-md-6 prefixform" style="display:none;">
                    <h6 class="aimslabel"><b>Company Group:  
                        <div class="input-group">
                            <input name = "cgrp" value ="" type="text" class="moduletxt txtcompanygroup input-sm form-control"><div class="frmdocumentno input-group-addon"><a  class ="cgrplookup proplookup" href="#"><i class="fa fa-chevron-circle-down"></i></a></div>
                        </div>
                    </h6>
                </div>
                    ...
                    <tbody id="compref-modulebody" class="compref-modulebody"style="height:400px;">
                        <?php
                            foreach ($comprefs as $key => $value) {
                                ...
                                <td class="col-description" id="comprefgroup-'.$comprefs[$key]['line'].'">'.$comprefs[$key]['cgrp'].'</td>
