...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
              ...
              <div class="box-body">
                ...
                <?php 
                if($moduledata['head']['trno'] != "" || $moduledata['head']['trno'] != null){
                  if($moduledata['head']['pi'] == "" && $moduledata['head']['pi'] == null){
                    $pi = "";
                  }else{
                    $pi = $moduledata['head']['pi'];
                  }//end if moduledata pi

                  echo '<h6 class="productioninstrutioncobj aimslabel"><b>PI #: <div class="input-group">
                    <input readonly="true" name = "prodinstruct" value ="'.$pi.'"  type="text" class="moduletxt txtprodinstruct form-control input-sm" disabled="true"></b>
                    <div class="input-group-addon"><a style="display:none;" class ="prodinstructbtn prodinstructlookup" href="#">
                    <i class="fa  fa-chevron-circle-down"></i></a></div>
                    </div></h6>';
                }else{
                  echo '<h6 style="display:none;" class="productioninstrutioncobj aimslabel"><b>PI #: <div class="input-group">
                    <input readonly="true" name = "prodinstruct" value =""  type="text" class="moduletxt txtprodinstruct form-control input-sm" disabled="true"></b>
                    <div class="input-group-addon"><a style="display:none;" class ="prodinstructbtn prodinstructlookup" href="#">
                    <i class="fa  fa-chevron-circle-down"></i></a></div>
                    </div></h6>';
                } //edn if
                ...
                <h6 class="aimslabel"><b>Our Ref: <input name="ourrefx" value ="<?php if(isset($moduledata)){echo $moduledata['head']['ourref'];}?>" type="text" class="moduletxt txtourref form-control input-sm" disabled="true"></b></h6>
                ...
                <!-- DATE -->
                <h6 class="aimslabel dateidlookup" style="display:none;"><b>Delivery Date: <div data-date-viewmode="days" data-date-format="yyyy-mm-dd" data-date="<?php if(isset($moduledata)){echo $moduledata['head']['deliverydate'];}?>"  class="paedit input-group date dpYears">
                  <input type="text" name = "deliverydate" readonly="" value="<?php if(isset($moduledata)){echo $moduledata['head']['deliverydate'];}?>" size="12" class="moduletxt txtdeliverydate form-control input-sm" disabled="true">
                  <div class="dateid-lookup input-group-addon add-on"><a href="#"><i class="fa fa-chevron-circle-down"></i></a></div>
                </div></b></h6>

                <h6 class="aimslabel dateidview"><b>Delivery Date :</b>
                <input disabled="true" name="deliverydateview" value ="<?php if(isset($moduledata)){echo $moduledata['head']['deliverydate'];}?>" type="text" class="moduletxt txtdeliverydateview form-control input-sm"></h6>
                <!-- DATE -->

                <h6 class="aimslabel"><b>PRC #: <input name="prc" value ="<?php if(isset($moduledata)){echo $moduledata['head']['prc'];}?>" type="text" class="moduletxt txtprc form-control input-sm" disabled="true"></b></h6>                
                </div><!-- /.col -->
                              ...
                              <thead>
                               ...
                               if(isset($moduledata['body']) && $moduledata['body'] != ""){
                                  foreach ($moduledata['body'] as $itmindex => $itmdata) {
                                    ...
                                    <td id="stockexpiry-'.$itmdata['line'].'" class="origdata nobody aimslabelstock"></td>                                    
