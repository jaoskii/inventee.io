                    ...
                    <table id="wishlist-table" class="clean-table linearize-table data-table">
                      ...
                      <tbody>
                        <tr id="item_31" class="first odd">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Sample Product" href="product_detail.html" class="product-image"> <img width="150" alt="Sample Product" src="products-images/product1.jpg"> </a></td>
