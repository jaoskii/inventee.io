...
$this->title = 'Sales Journal Report - SUMMARY(TON REN TANG)';
?>
...
Yii::$app->reporter->begintable('800');
       ...
       Yii::$app->reporter->col('CUSTOMER','200',null,false,'1px solid ','TB','L','Century Gothic','12','B','','');
       Yii::$app->reporter->col('DOCUMENT #','100',null,false,'1px solid ','TB','L','Century Gothic','12','B','','');
       Yii::$app->reporter->col('AMOUNT','100',null,false,'1px solid ','TB','R','Century Gothic','12','B','','');
      Yii::$app->reporter->col('COST','100',null,false,'1px solid ','TB','R','Century Gothic','12','B','','');
      Yii::$app->reporter->col('MARKUP','100',null,false,'1px solid ','TB','R','Century Gothic','12','B','','');
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col($data[$i]['supplier'],'200',null,false,'1px solid ','','L','Century Gothic','11','','','');
       Yii::$app->reporter->col($data[$i]['docno'],'100',null,false,'1px solid ','','L','Century Gothic','11','','','');
       Yii::$app->reporter->col(number_format($data[$i]['ext'],2),'100',null,false,'1px solid ','','R','Century Gothic','11','','','');
       Yii::$app->reporter->col(number_format($data[$i]['cost'],2),'100',null,false,'1px solid ','','R','Century Gothic','11','','','');
        $markup = $data[$i]['ext']-$data[$i]['cost'];
        Yii::$app->reporter->col(number_format($markup,2),'100',null,false,'1px solid ','','R','Century Gothic','11','','','');
 ...
 Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col('','200',null,false,'1px solid ','TB','C','Century Gothic','10','','','');
       Yii::$app->reporter->col('TOTAL :','100',null,false,'1px solid ','TB','R','Century Gothic','10','','','');
       Yii::$app->reporter->col(number_format($totalext,2),'100',null,false,'1px solid ','TB','R','Century Gothic','10','B','','');
       Yii::$app->reporter->col(number_format($totalcost,2),'100',null,false,'1px solid ','TB','R','Century Gothic','10','B','','');
       $markup = $totalext-$totalcost;
        Yii::$app->reporter->col(number_format($markup,2),'100',null,false,'1px solid ','TB','R','Century Gothic','10','','','');
       Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','C','Century Gothic','10','','','');
