...
$this->title = 'Sales Return Report - SUMMARY';
?>
...
//header
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Sales Return Summary Report',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col(strtoupper($data[$i]['supplier']),'300',null,false,'1px solid ','','L','Century Gothic','11','','','');
