<?php
//WTODO: [KIM][2019.09.17][Rate Listing layout]
date_default_timezone_set('Asia/Manila');
$this->title = 'Rate Listing';
//WTODO: [KIM][2019.11.13][update rate listing layout]
?>
...
Yii::$app->reporter->begintable('1000');
    Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('RATE LISTING',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('1000');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Qty','50',null,false,'1px solid ','B','C','Century Gothic','12','B','','6px');
        Yii::$app->reporter->col('Rate','50',null,false,'1px solid ','B','C','Century Gothic','12','B','','6px');
    ...
    Yii::$app->reporter->startrow();
      Yii::$app->reporter->addline();
        ...
        Yii::$app->reporter->col(number_format($data[$i]['payqty'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'50',null,false,'1px solid ','','R','Century Gothic','10','','','');
        Yii::$app->reporter->col(number_format($data[$i]['payrate'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'50',null,false,'1px solid ','','R','Century Gothic','10','','','');
        Yii::$app->reporter->endrow();
