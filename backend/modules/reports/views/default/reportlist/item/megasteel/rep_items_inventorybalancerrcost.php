...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('ITEM DESCRIPTION','300',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('PART','50',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
...
//        
        ...
        Yii::$app->reporter->col('','300',null,false,'1px solid ','','L','Century Gothic','11','Bi','','');
        Yii::$app->reporter->col('','50',null,false,'1px solid ','','L','Century Gothic','11','Bi','','');
        ...
        Yii::$app->reporter->col($data[$i]['partname'],'50',null,false,'1px solid ','','L','Century Gothic','11','','','');
