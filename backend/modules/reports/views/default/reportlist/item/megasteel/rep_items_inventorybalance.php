...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('PART','100',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
...
for($i=0;$i<count ($data);$i++){
    ...
    Yii::$app->reporter->addline();
        ...
        Yii::$app->reporter->col('','350',null,false,'1px solid ','','L','Century Gothic','11','Bi','','');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','','L','Century Gothic','11','Bi','','');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','','R','Century Gothic','11','','','');
        Yii::$app->reporter->col('','75',null,false,'1px solid ','','C','Century Gothic','11','','','');
        Yii::$app->reporter->col('','75',null,false,'1px solid ','','C','Century Gothic','11','','','');
        ...
        Yii::$app->reporter->col($data[$i]['itemname'],'350',null,false,'1px solid ','','L','Century Gothic','11','','','');
        Yii::$app->reporter->col($data[$i]['partname'],'100',null,false,'1px solid ','','C','Century Gothic','11','','','');
