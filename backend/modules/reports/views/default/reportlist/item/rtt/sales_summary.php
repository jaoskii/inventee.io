...
Yii::$app->reporter->begintable('800');
       ...
       Yii::$app->reporter->col('CUSTOMER','500',null,false,'1px solid ','TB','L','Avenir','12','B','','');
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col('','470',null,false,'2px solid ','TB','C','Avenir','10','','','');
       Yii::$app->reporter->col('TOTAL :','130',null,false,'2px solid ','TB','R','Avenir','10','','','');
