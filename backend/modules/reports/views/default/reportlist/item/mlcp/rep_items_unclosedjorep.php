...
$this->title = 'Unclosed Job Order Report';
//WTODO: [KIM][2019.10.03][unclosed job order report layout]
//WTODO: [KIM][2019.12.09][update layout for unclosed job order report layout]
?>
...
$end=$params['end'];
  Yii::$app->reporter->begintable('1000');
    ...
    Yii::$app->reporter->startrow();
      Yii::$app->reporter->col('UNCLOSED JOB ORDER REPORT',null,null,false,'1px solid ','','C','Century Gothic','14','B','','').'<br />';
