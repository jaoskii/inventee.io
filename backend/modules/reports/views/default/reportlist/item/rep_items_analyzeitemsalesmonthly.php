...
Yii::$app->reporter->begintable('1000');
        ...
        Yii::$app->reporter->col('ANALYZE ITEM SALES (MONTHLY)',null,null,false,'1px solid ','','','Helvetica','18','B','','').'<br />';
        Yii::$app->reporter->endrow();

        Yii::$app->reporter->startrow();
        if ($params['customer']==''){
            Yii::$app->reporter->col('Customer : ALL',NULL,null,false,'1px solid ','','L','Helvetica','10','','','');
        } else {
        Yii::$app->reporter->col('Customer : '. strtoupper($params['customername']),NULL,null,false,'1px solid ','','L','Helvetica','10','','','');
        }
        if ($params['barcode']==''){
        ...
        Yii::$app->reporter->col('Warehouse : '. strtoupper($params['wh']),null,null,false,'1px solid ','','L','Helvetica','10','','','');
...
Yii::$app->reporter->begintable('1000');
       ...
       Yii::$app->reporter->col('ANALYZE ITEM SALES (MONTHLY)',null,null,false,'1px solid ','','','Helvetica','18','B','','').'<br />';
        ...
        Yii::$app->reporter->col('Category :'. strtoupper($params['generic']),null,null,false,'1px solid ','','L','Helvetica','10','','','');
        }
        //Yii::$app->reporter->col('Center : '.$cname,null,null,false,'1px solid ','','L','Helvetica','10','','','');
        Yii::$app->reporter->col('Stock : '.strtoupper($params['itemtype']),null,null,false,'1px solid ','','L','Helvetica','10','','','');
        // Yii::$app->reporter->col('Printdate :'. date('M-d-Y h:i:s a',time()),null,null,false,'1px solid ','','R','Helvetica','10','','','');
        Yii::$app->reporter->pagenumber('Page');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
