...
$this->title = 'Item Balance - Above Maximum';
?>
...
Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Item Balance - Above Maximum','400',null,false,'1px solid ','','','Helvetica','18','B','','').'<br />';
...
Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('MAXIMUM STOCK','150',null,false,'1px solid ','','L','Helvetica','10','','','');
...
for($i=0;$i<count ($data);$i++){
    ...
    Yii::$app->reporter->col(number_format($data[$i]['maximum'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'150',null,false,'1px solid ','','R','Helvetica','10','','','');
    $totalbal=$totalbal+$data[$i]['balance'];
    $totalmin=$totalmin+$data[$i]['maximum'];
    Yii::$app->reporter->endrow();
}
