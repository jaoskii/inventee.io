...
for($i=0;$i<count($data);$i++){
   ...
   Yii::$app->reporter->startrow();
        if ($item==$data[$i]['itemname']){
            ...
            $dis=Yii::$app->reporter->col($item_desc,'300',null,false,'1px dotted ','T','L','Century Gothic','10','B','b','');
   ...
   Yii::$app->reporter->col($data[$i]['clientname'],'300',null,false,'1px solid ','','L','Century Gothic','10','','','5px');
   Yii::$app->reporter->col(number_format($data[$i]['sales'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'200',null,false,'1px solid ','','R','Century Gothic','10','','','5px');
   Yii::$app->reporter->endrow();
