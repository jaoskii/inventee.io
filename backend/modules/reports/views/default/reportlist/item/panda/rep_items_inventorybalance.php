...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('MINIMUM','50',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('MAXIMUM','50',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
...
for($i=0;$i<count ($data);$i++){
    ...
    Yii::$app->reporter->addline();
        ...
        Yii::$app->reporter->col('','350',null,false,'1px solid ','','L','Century Gothic','11','Bi','','');
        ...
        if($data[$i]['brandname'] != ""){
            $item_desc = $data[$i]['brandname'] . " " . $item_desc;
        }//end if

        if($data[$i]['modelname'] != ""){
            $item_desc = $item_desc . " " . $data[$i]['modelname'];
        }//end if

        if($data[$i]['sizeid'] != ""){
            $item_desc = $item_desc . " " . $data[$i]['sizeid'];
        }//end if

        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col($data[$i]['barcode'],'100',null,false,'1px solid ','','C','Century Gothic','11','','','');
        Yii::$app->reporter->col($item_desc,'450',null,false,'1px solid ','','L','Century Gothic','11','','','');
        Yii::$app->reporter->col($data[$i]['uom'],'100',null,false,'1px solid ','','C','Century Gothic','11','','','');
        Yii::$app->reporter->col($data[$i]['minimum'],'50',null,false,'1px solid ','','C','Century Gothic','11','','','');
        Yii::$app->reporter->col($data[$i]['maximum'],'50',null,false,'1px solid ','','C','Century Gothic','11','','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('ITEM CODE','100',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('ITEM DESCRIPTION','450',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('UOM','100',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('MINIMUM','50',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('MAXIMUM','50',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('BALANCE','75',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
...
echo '<br/>';
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('OVERALL STOCKS :','450',null,false,'1px solid ','TB','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','R','Century Gothic','11','','','');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','R','Century Gothic','11','','','');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','R','Century Gothic','11','','','');
        Yii::$app->reporter->col(number_format($totalbalqty,Yii::$app->systemsettings->setDecimaldisplay('quantity')),'75',null,false,'1px solid ','TB','C','Century Gothic','11','B','30px','8px');
