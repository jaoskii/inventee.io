...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('ITEM DESCRIPTION','250',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
        ...
        Yii::$app->reporter->col('COST','75',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
...
//        
        ...
        Yii::$app->reporter->col($item_desc,'350',null,false,'1px solid ','','L','Century Gothic','11','','','');
        Yii::$app->reporter->col($data[$i]['uom'],'75',null,false,'1px solid ','','C','Century Gothic','11','','','');
        ...
        Yii::$app->reporter->col($cost,'75',null,false,'1px solid ','','R','Century Gothic','11','','','');
