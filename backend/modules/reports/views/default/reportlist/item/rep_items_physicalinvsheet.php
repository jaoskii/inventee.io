...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('PHYSICAL INVENTORY SHEET',null,null,false,'1px solid ','','C','Century Gothic','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('WAREHOUSE: '.$whtitle,'150',null,false,'1px solid ','','','Century Gothic','11','','','3px');
        Yii::$app->reporter->endrow(); 
        ...
        Yii::$app->reporter->col('','100',null,false,'1px dashed ','B','','Century Gothic','11','','','3px');
        Yii::$app->reporter->endrow(); 
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('DESCRIPTION','400',null,false,'1px dashed ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('UNIT','100',null,false,'1px dashed ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('QTY/COUNT','100',null,false,'1px dashed ','B','C','Century Gothic','11','B','30px','8px');
        Yii::$app->reporter->col('','2',null,false,'1px solid ','B','C','Century Gothic','11','','30px','8px');
        Yii::$app->reporter->col('REMARKS','100',null,false,'1px dashed ','B','C','Century Gothic','11','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col($data[$i]['itemname'],'400',null,false,'1px dashed ','','L','Century Gothic','10','','','3px');
        Yii::$app->reporter->col($data[$i]['uom'],'100',null,false,'1px dashed ','','L','Century Gothic','10','','','3px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','B','R','Century Gothic','10','','','3x');    
        Yii::$app->reporter->col('','2',null,false,'1px solid ','','R','Century Gothic','10','','','3px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','B','L','Century Gothic','10','','','3px');    
    Yii::$app->reporter->endrow();
}
...
Yii::$app->reporter->col('','400',null,false,'1px dashed ','B','L','Century Gothic','11','B','30px','8px');
Yii::$app->reporter->col('','100',null,false,'1px dashed ','B','L','Century Gothic','11','B','30px','8px');
Yii::$app->reporter->col('','100',null,false,'1px dashed ','B','R','Century Gothic','11','B','30px','8px');
Yii::$app->reporter->col('','2',null,false,'1px solid ','','R','Century Gothic','11','','30px','8px');
