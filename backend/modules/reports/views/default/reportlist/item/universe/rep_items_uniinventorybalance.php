<?php
//WTODO: [KIM][2019.09.04][inventory balance for universe]
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('ITEM CODE','100',null,false,'1px solid ','B','C','Helvetica','14','B','30px','8px');
        Yii::$app->reporter->col('ITEM DESCRIPTION','450',null,false,'1px solid ','B','C','Helvetica','14','B','30px','8px');
        Yii::$app->reporter->col('UOM','100',null,false,'1px solid ','B','C','Helvetica','14','B','30px','8px');
...
for($i=0;$i<count ($data);$i++){
    Yii::$app->reporter->addline();
        ...
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col($data[$i]['barcode'],'100',null,false,'1px solid ','','C','Helvetica','14','','','');
...
echo '<br/>';
    Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','C','Helvetica','14','B','30px','8px');
        Yii::$app->reporter->col('OVERALL STOCKS :','450',null,false,'1px solid ','TB','C','Helvetica','14','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','C','Helvetica','14','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','R','Helvetica','14','','','');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','C','Helvetica','14','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','R','Helvetica','14','','','');
        Yii::$app->reporter->col('','100',null,false,'1px solid ','TB','R','Helvetica','14','','','');
        Yii::$app->reporter->col(number_format($totalbalqty,Yii::$app->systemsettings->setDecimaldisplay('quantity')),'75',null,false,'1px solid ','TB','C','Helvetica','14','B','30px','8px');
