...
$this->title = 'Purchase Summary Per Principal/Supplier';
//WTODO: [KIM][2019.10.30][update layout for purchase summary per principal/supplier]
?>
...
$header=Yii::$app->reporter->letterhead();
  Yii::$app->reporter->startrow();
    echo '<br/>';
    Yii::$app->reporter->col('PURCHASE SUMMARY PER PRINCIPAL/SUPPLIER',null,null,false,'1px solid','','C','Century Gothic','18','B','','').'<br/>';
    ...
    for($i=0;$i<count($data);$i++){
      ...
      Yii::$app->reporter->startrow();
        Yii::$app->reporter->addline();
          ...
          Yii::$app->reporter->col($data[$i]['clientname'],'300',null,false,'1px solid ','','L','Century Gothic','11','','','');
