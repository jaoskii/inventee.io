...
$this->title = 'Top Performing Category';
?>
...
$header=Yii::$app->reporter->letterhead();
  Yii::$app->reporter->startrow();
  	echo '<br/>';
  	Yii::$app->reporter->col('TOP PERFORMING CATEGORY',null,null,false,'1px solid','','C','Helvetica','18','B','','').'<br/>';
...
Yii::$app->reporter->begintable('800');
  Yii::$app->reporter->startrow();
    ...
    Yii::$app->reporter->col('CATEGORY CODE','200',null,false,'1px solid','B','L','Helvetica','11','B','','8px');
    Yii::$app->reporter->col('','100',null,false,'1px solid','B','C','Helvetica','11','B','','8px');
    Yii::$app->reporter->col('CATEGORY NAME','250',null,false,'1px solid','B','L','Helvetica','11','B','','8px');
...
for ($i=0; $i < count($data); $i++) { 
  ...
  Yii::$app->reporter->col($data[$i]['code'],'200',null,false,'1px solid','','L','Helvetica','11','','','8px');
  Yii::$app->reporter->col('','100',null,false,'1px solid','','C','Helvetica','11','','','8px');
  Yii::$app->reporter->col($data[$i]['category'],'250',null,false,'1px solid','','L','Helvetica','11','','','8px');
  ...
  Yii::$app->reporter->col('','200',null,false,'1px solid','','L','Helvetica','11','','','8px');
  Yii::$app->reporter->col('','100',null,false,'1px solid','','C','Helvetica','11','','','8px');
  Yii::$app->reporter->col('GRAND TOTAL:','250',null,false,'1px dotted','T','R','Helvetica','11','B','','8px');
