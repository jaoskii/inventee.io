...
$this->title = 'Top Performing Division';
?>
...
$header=Yii::$app->reporter->letterhead();
  Yii::$app->reporter->startrow();
    echo '<br/>';
    Yii::$app->reporter->col('TOP PERFORMING DIVISION',null,null,false,'1px solid','','C','Helvetica','18','B','','').'<br/>';
...
Yii::$app->reporter->begintable('800');
  Yii::$app->reporter->startrow();
    ...
    Yii::$app->reporter->col('DIVISION CODE','150',null,false,'1px solid','B','L','Helvetica','11','B','','8px');
    Yii::$app->reporter->col('','100',null,false,'1px solid','B','C','Helvetica','11','B','','8px');
    Yii::$app->reporter->col('DIVISION NAME','300',null,false,'1px solid','B','L','Helvetica','11','B','','8px');
