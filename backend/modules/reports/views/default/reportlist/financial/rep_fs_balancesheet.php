...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('BALANCE SHEET',null,null,false,'1px solid ','','','Century Gothic','15','B','','');
...
//{}else{
    ...
    Yii::$app->reporter->col($amt,'100',null,false,'1px solid ','','','Century Gothic','10','','','');
    ...
    Yii::$app->reporter->col($total,'100',null,false,'1px solid ','','','Century Gothic','10','B','','');
