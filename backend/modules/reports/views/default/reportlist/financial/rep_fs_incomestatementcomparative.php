...
$this->title = 'Comparative Income Statement';
?>
...
Yii::$app->reporter->col('COMPARATIVE INCOME STATEMENT',null,null,false,'1px solid ','','','Century Gothic','15','B','','');
Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();

Yii::$app->reporter->begintable('1300');
Yii::$app->reporter->startrow();
Yii::$app->reporter->col('Center :  '.$params['center'],100,null,false,'1px solid ','','','Century Gothic','12','B','','');
//Yii::$app->reporter->col('Printdate : '. date('M-d-Y h:i:s a',time()),100,null,false,'1px solid ','','','Century Gothic','10','','','');
Yii::$app->reporter->endrow();
Yii::$app->reporter->startrow();
