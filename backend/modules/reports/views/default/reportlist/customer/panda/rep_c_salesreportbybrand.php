...
$this->title = 'Sales Report By Band Report';
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('SALES REPORT BY BRAND',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('CUSTOMER NAME','250',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
