...
Yii::$app->reporter->begintable('800');
       ...
       Yii::$app->reporter->col('DATE','350',null,false,'1px solid ','TB','C','Century Gothic','11','B','','');
       Yii::$app->reporter->col('DOCUMENT #','150',null,false,'1px solid ','TB','C','Century Gothic','11','B','','');
       Yii::$app->reporter->col('REFERENCE','150',null,false,'1px solid ','TB','C','Century Gothic','11','B','','');
...
if ($itemname==""){
 ...
 Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col($data[$i]['clientname'],'350',null,false,'1px dotted ','B','L','Century Gothic','12','B','','5px');
    ...
    if (strtoupper($docno)==strtoupper($data[$i]['clientname'])){
       ...
       if ($itemname!=''){  
            ...
            Yii::$app->reporter->startrow();
                ...
                Yii::$app->reporter->col('SUB TOTAL :','150',null,false,'1px dotted ','','R','Century Gothic','11','B','','');
        ...
        Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col($data[$i]['clientname'],'350',null,false,'1px dotted ','B','L','Century Gothic','11','B','','5px');
        Yii::$app->reporter->col('','150',null,false,'1px dotted ','B','C','Century Gothic','11','','','');
        Yii::$app->reporter->col('','150',null,false,'1px dotted ','B','C','Century Gothic','11','','','');
        Yii::$app->reporter->col('','150',null,false,'1px dotted ','B','C','Century Gothic','11','','','');
...
if ($iitem==$data[$i]['clientname']){
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col($data[$i]['dateid'],'350',null,false,'1px solid ','','C','Century Gothic','10','','','1px');
        Yii::$app->reporter->col($data[$i]['docno'],'150',null,false,'1px solid ','','C','Century Gothic','10','','','1px');
        Yii::$app->reporter->col($data[$i]['yourref'],'150',null,false,'1px solid ','','C','Century Gothic','10','','','1px');
    ...
    Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','350',null,false,'1px solid ','','C','Century Gothic','10','B','','');
        Yii::$app->reporter->col('','150',null,false,'1px dotted ','','R','Century Gothic','10','B','','');
        Yii::$app->reporter->col('SUB TOTAL :','150',null,false,'1px dotted ','','R','Century Gothic','10','B','','');
        Yii::$app->reporter->col(number_format($gsubtotalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'150',null,false,'1px dotted ','T','R','Century Gothic','10','B','','');
    Yii::$app->reporter->endrow();
