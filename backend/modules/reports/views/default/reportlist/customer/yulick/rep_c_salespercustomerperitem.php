...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('CUSTOMER NAME','250',null,false,'1px solid ','B','C','Century Gothic','12','B','20px','8px');
        Yii::$app->reporter->col('ITEM NAME ','250',null,false,'1px solid ','B','C','Century Gothic','12','B','20px','8px');
        Yii::$app->reporter->col('SELLING PRICE','150',null,false,'1px solid ','B','C','Century Gothic','12','B','20px','8px');
        Yii::$app->reporter->col('SALES/QUANTITY','150',null,false,'1px solid ','B','C','Century Gothic','12','B','20px','8px');
    Yii::$app->reporter->endrow();    
Yii::$app->reporter->endtable();  
...
for($i=0;$i<count($data);$i++){
   ...
   Yii::$app->reporter->startrow();
        if ($item==$data[$i]['clientname']){
            ...
            $dis=Yii::$app->reporter->col($data[$i]['clientname'].' ( '.$data[$i]['client'].' ) ','250',null,false,'1px dotted ','T','L','Century Gothic','10','B','b','');
            $dis2=Yii::$app->reporter->col('','250',null,false,'1px dotted ','T','L','B','10','B','','');
            $dis3=Yii::$app->reporter->col('','150',null,false,'1px dotted ','T','L','B','10','B','','');
            $dis4=Yii::$app->reporter->col('','150',null,false,'1px dotted ','T','L','B','10','B','','');
   ...
   Yii::$app->reporter->startrow();
   Yii::$app->reporter->col('','250',null,false,'1px solid ','','L','Century Gothic','10','','','0px 0px 0px 50px');
   Yii::$app->reporter->col(' ( ' . $data[$i]['barcode'] . ' )  - ' .$data[$i]['rem'],'250',null,false,'1px solid ','','L','Century Gothic','10','','','5px');
   Yii::$app->reporter->col(number_format($data[$i]['latestcost'],$ab),'150',null,false,'1px solid ','','R','Century Gothic','10','','','5px');
   Yii::$app->reporter->col(number_format($data[$i]['sales'],$ab),'150',null,false,'1px solid ','','R','Century Gothic','10','','','5px');
   Yii::$app->reporter->endrow();
