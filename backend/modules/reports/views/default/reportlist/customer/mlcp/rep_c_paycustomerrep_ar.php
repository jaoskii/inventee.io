...
$this->title = 'Payable to Customer Report';
//WTODO: [KIM][2019.12.09][layout for payable to customer report]
?>
...
Yii::$app->reporter->beginreport('800');
  ...
  Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
      Yii::$app->reporter->col('PAYABLE TO CUSTOMER REPORT',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
  ...
  Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
      Yii::$app->reporter->col('CUSTOMER NAME','110',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
      ...
      Yii::$app->reporter->col('No. of days','110',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
      ...
      for($i=0;$i<count($data);$i++){
        ...
        if ($itemname!=''){  
          Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col(number_format($gsubtotalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'110',null,false,'1px dotted ','T','R','Century Gothic','13','B','','');
          Yii::$app->reporter->endrow();
        }    
    ...
    Yii::$app->reporter->startrow();
      ...
      Yii::$app->reporter->col(number_format($totalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'110',null,false,'1px dotted ','T','R','Century Gothic','13','B','','');
    Yii::$app->reporter->endrow();
