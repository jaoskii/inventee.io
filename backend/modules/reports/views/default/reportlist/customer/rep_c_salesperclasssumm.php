...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('CLASSIFICATION','400',null,false,'1px dotted ','TB','L','Century Gothic','11','B','','3px');
...
for($i=0;$i<count($data);$i++){
   ...
   Yii::$app->reporter->col($data[$i]['class'],'400',null,false,'1px solid ','','L','Century Gothic','10','','','');
   Yii::$app->reporter->col(number_format($data[$i]['isqty'],2),'100',null,false,'1px solid ','','R','Century Gothic','10','','','');
   Yii::$app->reporter->col(number_format($tons,3),'100',null,false,'1px solid ','','R','Century Gothic','10','','','');
   Yii::$app->reporter->col(number_format($data[$i]['ext'],2),'200',null,false,'1px solid ','','R','Century Gothic','10','','','');
   Yii::$app->reporter->endrow();
...
//     }
 ...
 Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('','400',null,false,'1px dotted ','TB','L','Century Gothic','11','B','','3px');
        Yii::$app->reporter->col(number_format($totalqty,2),'100',null,false,'1px dotted ','TB','R','Century Gothic','11','B','','3px');
        Yii::$app->reporter->col(number_format($totaltons,3),'100',null,false,'1px dotted ','TB','R','Century Gothic','11','B','','3px');
        Yii::$app->reporter->col(number_format($totalamt,2),'200',null,false,'1px dotted ','TB','R','Century Gothic','11','B','','3px');
        Yii::$app->reporter->endrow();
