...
Yii::$app->reporter->begintable('900');
    Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('CUSTOMER','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
        Yii::$app->reporter->col('DOCUMENT #','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
        Yii::$app->reporter->col('DATE','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
        Yii::$app->reporter->col('0-30 days','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
        Yii::$app->reporter->col('31-60 days','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
        Yii::$app->reporter->col('61-90 days','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
        Yii::$app->reporter->col('91-120 days','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
        Yii::$app->reporter->col('120+ days','100',null,false,'1px solid ','B','C','Helvetica','11','B','','');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['clientname'],'100',null,false,'1px solid ','','L','Helvetica','10','','','');
...
Yii::$app->reporter->begintable('900');
    ...
    Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','100',null,false,'1px dotted ','T','L','Helvetica','10','','','5px');
        Yii::$app->reporter->col('','100',null,false,'1px dotted ','T','L','Helvetica','10','','','5px');
        Yii::$app->reporter->col('TOTAL : ','100',null,false,'1px dotted','T','L','Helvetica','10','B','','5px');
        Yii::$app->reporter->col(number_format($tota,2),'100',null,false,'1px dotted ','T','r','Helvetica','10','B','','5px');
        Yii::$app->reporter->col(number_format($totb,2),'100',null,false,'1px dotted ','T','r','Helvetica','10','B','','5px');
        Yii::$app->reporter->col(number_format($totc,2),'100',null,false,'1px dotted ','T','r','Helvetica','10','B','','5px');
        Yii::$app->reporter->col(number_format($totd,2),'100',null,false,'1px dotted ','T','r','Helvetica','10','B','','5px');
        Yii::$app->reporter->col(number_format($tote,2),'100',null,false,'1px dotted ','T','r','Helvetica','10','B','','5px');
