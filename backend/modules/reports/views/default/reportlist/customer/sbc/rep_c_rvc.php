...
$this->title = 'Receivables Vs Collection';
?>
...
Yii::$app->reporter->beginreport('1650');
    Yii::$app->reporter->begintable('1650');
        ...
        Yii::$app->reporter->startrow();
            Yii::$app->reporter->col('Receivables vs COLLECTION - Annual '.$params['year'],'1500','','','1px solid ','','L','century gothic','18','B','','');
        Yii::$app->reporter->startrow();
    ...
    Yii::$app->reporter->begintable('1650');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col('AR' ,'45','','','1px solid ','RB','C','century gothic','9','B','','');
            ...
            Yii::$app->reporter->col('COL.' ,'45','','','1px solid ','B','C','century gothic','9','B','','');
            Yii::$app->reporter->col('' ,'6','','','1px solid ','','C','century gothic','9','B','','');
            Yii::$app->reporter->col('AR' ,'50','','','1px solid ','RB','C','century gothic','9','B','','');
