...
$this->title = 'Commission Report - Agent';
?>
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col('CUSTOMER','100',null,false,'1px dotted ','TB','C','Century Gothic','11','B','','3px');
...
if ($client==""){
        ...
        Yii::$app->reporter->startrow();
            Yii::$app->reporter->col($data[$i]['agentname'],'200',null,false,'1px dotted ','B','L','Century Gothic','12','B','','5px');
        ...
        if (strtoupper($client)==strtoupper($data[$i]['agentname'])){
            $client="";
            
    if (strtoupper($agent)==strtoupper($data[$i]['agentname'])){
        $agent="";
    }else{
       if ($agent!=''){  
         ...
         //   $subtotalpv=0;
                ...
                $client=strtoupper($data[$i]['agentname']);  
              }
...
//                 //brand
                ...
                $agent=strtoupper($data[$i]['agentname']);  
              }
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col($data[$i]['custname'],'100',null,false,'1px solid ','','L','Century Gothic','10','','','1px');
