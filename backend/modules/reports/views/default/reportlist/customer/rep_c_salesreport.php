...
Yii::$app->reporter->begintable('800');
       ...
       Yii::$app->reporter->col('CLIENT NAME','300',null,false,'1px solid ','TB','C','Century Gothic','11','B','','');
       Yii::$app->reporter->col('TOTAL AMOUNT','200',null,false,'1px solid ','TB','C','Century Gothic','11','B','','');
$Tot=0;
$amt=0;
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col(number_format($data[$i]['amount'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'100',null,false,'1px solid ','','R','Century Gothic','10','','','');
       Yii::$app->reporter->endrow();
...
Yii::$app->reporter->begintable('800');
      Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col('','100px',null,false,'1px solid ','TB','C','Century Gothic','10','','','');
       Yii::$app->reporter->col('','100px',null,false,'1px solid ','TB','C','Century Gothic','10','','','');
       Yii::$app->reporter->col('GRAND TOTAL :','300px',null,false,'1px solid ','TB','L','Century Gothic','10','B','','');
