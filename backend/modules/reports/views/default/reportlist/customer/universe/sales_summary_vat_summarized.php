...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col($data[$i]['supplier'],'300',null,false,'1px dashed ','B','L','Helvetica','11','','','');
...
Yii::$app->reporter->startrow();
       ...
       Yii::$app->reporter->col('GRAND TOTAL :','300',null,false,'2px solid ','TB','L','Helvetica','10','b','','');
       Yii::$app->reporter->col('','100',null,false,'2px solid ','TB','L','Helvetica','10','','','');
