...
$this->title = 'Inventory Adjustment Report';
?>
...
// var_dump($params);
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Inventory Adjustment Report',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
for($i=0;$i<count($data);$i++)
{
    ...
    if($docno=="" || $docno!=$data[$i]['docno']) 
    {
        ...
        Yii::$app->reporter->begintable('1000');
            ...
            Yii::$app->reporter->endrow();
            // Yii::$app->reporter->startrow();
            //     Yii::$app->reporter->col('Source: '.$data[$i]['whsource'],'125',null,false,'1px solid ','','L','Century Gothic','11','B','false','8px');
            //     Yii::$app->reporter->col('Destination: '.$data[$i]['whdestination'],'125',null,false,'1px solid ','','L','Century Gothic','11','B','false','8px');
            // Yii::$app->reporter->endrow();
            // Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->begintable('1000');
            ...
            //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
                ...
                Yii::$app->reporter->col('Item Description','150',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
                Yii::$app->reporter->col('Quantity','10',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
                ...
                Yii::$app->reporter->col('Expiry','100',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
                Yii::$app->reporter->col('Notes','150',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
            Yii::$app->reporter->endrow();
        Yii::$app->reporter->endtable(); 
    } 
    Yii::$app->reporter->begintable('1000');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col($data[$i]['itemname'],'150',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
            if($data[$i]['iss']>'0') {
                ...
                Yii::$app->reporter->col(number_format($data[$i]['rrqty'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'100',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
                Yii::$app->reporter->col($data[$i]['uom'],'100',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
                Yii::$app->reporter->col(number_format($data[$i]['rrcost'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'100',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
            }
            ...
            Yii::$app->reporter->col($data[$i]['expiry'],'100',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
            Yii::$app->reporter->col($data[$i]['rem'],'150',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
        Yii::$app->reporter->endrow();
