...
$this->title = 'Physical Count Report';
?>
...
// var_dump($params);
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Physical Count Report',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
for($i=0;$i<count($data);$i++)
{
    ...
    Yii::$app->reporter->begintable('1000');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col(number_format($data[$i]['rrqty'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'100',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
