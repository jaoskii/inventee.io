...
$this->title = 'Cash/Check Voucher List';
?>
...
$start=$params['start'];
 ...
 Yii::$app->reporter->startrow();           
    Yii::$app->reporter->col('Cash/Check Voucher List','1000',null,false,'1px dotted','','','Century Gothic','18','B','30px','8px');
...
for($i=0;$i<count($data);$i++)
{
    ...
    if($docno=="" || $docno!=$data[$i]['docno']) 
    {
        ...
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('<b>'.'Supplier: '.'</b>'.$data[$i]['hclientname'],'100',null,false,'1px solid ','','','Century Gothic','10','','','2px');
        Yii::$app->reporter->endrow();
         Yii::$app->reporter->endtable();
