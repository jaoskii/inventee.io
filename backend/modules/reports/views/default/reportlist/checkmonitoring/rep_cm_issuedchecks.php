...
Yii::$app->reporter->begintable('800',null,'','1px solid ','','','Century Gothic','','','','');
        ...
        Yii::$app->reporter->col('ISSUED CHECKS',null,null,false,'1px solid ','','','Century Gothic','15','B','','');
...
Yii::$app->reporter->printline();
   Yii::$app->reporter->printline();
                  ...
                  Yii::$app->reporter->col('Supplier Name', '350', '', false, '1px dashed','B','c', 'Century Gothic', '',  'b', '', '', '' ,'600');
