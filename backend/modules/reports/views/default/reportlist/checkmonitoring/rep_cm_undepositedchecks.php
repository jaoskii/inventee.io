...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('UNDEPOSITED CHECKS',null,null,false,'1px solid ','','','Century Gothic','15','B','','');
        ...
        Yii::$app->reporter->col('','200',null,false,'1px solid ','','','Century Gothic','10','','','');
        Yii::$app->reporter->endrow();
...
Yii::$app->reporter->endrow();
    ...
    //$txt='',$w=null,$h=null, $bg=false,  $b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m=''
     ...
     $value=array('',$data_['docno'],date('M-d-Y', strtotime($data_['trdate'])),$data_['chkinfo'],date('M-d-Y', strtotime($data_['chkdate'])),number_format($data_['amount'],Yii::$app->systemsettings->setDecimaldisplay('currency')));
    $c=$c+$data_['amount'];
     $total = $total + $c;
