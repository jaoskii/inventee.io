...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('PURCHASE '.strtoupper($params['purchasereporttype']),null,null,false,'1px solid ','','','Helvetica','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        if($params['reporttype'] == "detailed"){
            Yii::$app->reporter->col('DATE','60',null,false,'1px solid ','B','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','B','30px','10px');
            Yii::$app->reporter->col('DOCUMENT #','20px',null,false,'1px solid ','B','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','B','30px','10px');
            Yii::$app->reporter->col('REFERENCE #','20px',null,false,'1px solid ','B','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','','30px','10px');
            Yii::$app->reporter->col('SUPPLIER NAME','90px',null,false,'1px solid ','B','C','Helvetica','11','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->addline();
        ...
        if($params['reporttype'] == "detailed"){
            Yii::$app->reporter->col($data[$i]['dateid'],'60',null,false,'1px solid ','','C','Helvetica','10','','','');
            ...
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','10','','','');
            Yii::$app->reporter->col($data[$i]['yourref'],'20px',null,false,'1px solid ','','C','Helvetica','10','','','');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','10','','','');
            Yii::$app->reporter->col($data[$i]['clientname'],'90px',null,false,'1px solid ','','L','Helvetica','10','','','');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','10','','','');
        }else{
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        if($params['reporttype'] == "detailed"){
            ...
            Yii::$app->reporter->col('SUPPLIER NAME','350',null,false,'1px solid ','B','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('TIN','100',null,false,'1px solid ','B','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','B','30px','8px');
        }//enmd if
        ...
        Yii::$app->reporter->startrow();
        if($params['reporttype'] == "detailed"){
            Yii::$app->reporter->col('     ','60',null,false,'1px solid ','','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','B','30px','10px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','B','30px','10px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','C','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','','30px','10px');
            Yii::$app->reporter->col('GRAND TOTAL:','90px',null,false,'1px solid ','T','L','Helvetica','11','B','30px','8px');
            Yii::$app->reporter->col('     ','20px',null,false,'1px solid ','','L','Helvetica','11','B','30px','8px');
        }else{
