...
$this->title = 'Current Supplier Payables Aging - SUMMARY';
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('CURRENT SUPPLIER PAYABLES AGING - SUMMARY',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('CLIENT NAME','110px',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['clientname'],'110px',null,false,'1px solid ','','L','Century Gothic','10','','','');
