...
$this->title = 'Supplier Performance Report';
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('SUPPLIER PERFORMANCE REPORT',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('800');
       ...
       Yii::$app->reporter->col('SUPPLIER NAME','400',null,false,'1px solid ','TB','C','Century Gothic','12','B','','3px');
...
Yii::$app->reporter->endtable();
$totalsales=number_format($data1[0]['amount'],Yii::$app->systemsettings->setDecimaldisplay('currency'));
Yii::$app->reporter->begintable('800');
       Yii::$app->reporter->startrow();
       Yii::$app->reporter->col('CODE','100',null,false,'1px solid ','TB','C','Century Gothic','12','B','','3px');
       Yii::$app->reporter->col('SUPPLIER NAME','400',null,false,'1px solid ','TB','C','Century Gothic','12','B','','3px');
