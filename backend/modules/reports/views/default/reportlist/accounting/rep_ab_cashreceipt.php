...
$this->title = 'Cash Receipt Book - Detailed';
?>
...
Yii::$app->reporter->begintable('800',null,'','1px solid ','','','Century Gothic','','','','');
        ...
        Yii::$app->reporter->col('DETAILED CASH RECEIPT BOOK',null,null,'','1px solid ','','l','Century Gothic','18','b','','');
        ...
        Yii::$app->reporter->startrow(null,null,'','1px solid ','','l','Century Gothic','10','','');
            Yii::$app->reporter->col('Agent: '. strtoupper($params['agent']),null,null,'','1px solid ','','l','Century Gothic','10','','');
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
                 ...
                 Yii::$app->reporter->col('DOCUMENT #',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('CUSTOMER NAME PARTICULARS',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('DATE',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('ACCOUNT CODE',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('ACCOUNT DESCRIPTION',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('REFFERENCE #',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                  Yii::$app->reporter->col('DEBIT',null,null,'','1px solid ','B','r','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('CREDIT',null,null,'','1px solid ','B','r','Century Gothic','10','B','','');
...
Yii::$app->reporter->begintable('800');
    ...
    Yii::$app->reporter->startrow('',null,'','1px solid ','','B','Century Gothic','','b','','');
                 Yii::$app->reporter->col('',null,null,'','1px solid ','T','c','','','','','');
                 Yii::$app->reporter->col('',null,null,'','1px solid ','T','c','','','','','');
                 Yii::$app->reporter->col('',null,null,'','1px solid ','T','c','','','','','');
                 Yii::$app->reporter->col('',null,null,'','1px solid ','T','c','','','','','');
                 Yii::$app->reporter->col('GRAND TOTAL: ',null,null,'','1px solid ','T','c','Century Gothic','10','','','');
                 Yii::$app->reporter->col('',null,null,'','1px solid ','T','c','','','','','');
