...
Yii::$app->reporter->begintable('800',null,'','1px solid ','','','Century Gothic','','','','');
        ...
        Yii::$app->reporter->col('DETAILED CASH DISBURSEMENT BOOK - SUMMARIZED',null,null,'','1px solid ','','l','Century Gothic','18','B','','');
...
//var_dump($params);
//var_dump($data);
Yii::$app->reporter->begintable('800',null,'','1px solid ','','','','','','','');

        Yii::$app->reporter->startrow('',null,'','1px solid ','','','','Century Gothic','B','11','','');
                 Yii::$app->reporter->col('ACCOUNT CODE',null,null,'','1px solid ','B','l','Century Gothic','','');
                 Yii::$app->reporter->col('ACCOUNT DESCRIPTION',null,null,'','1px solid ','B','c','Century Gothic','','Century Gothic','','');
                 Yii::$app->reporter->col('DEBIT',null,null,'','1px solid ','B','r','','Century Gothic','B','','');
                 Yii::$app->reporter->col('CREDIT',null,null,'','1px solid ','B','r','','Century Gothic','B','','');
        Yii::$app->reporter->endrow();
      $totalardb=0;
	    $totalrcr=0;
	    $totaldb=0;
...
echo '<br/><br/>';
        ...
        Yii::$app->reporter->startrow(NULL,null,false,'1px solid ','','R','Century Gothic','10','','','');
            ...
            //Yii::$app->reporter->pagenumber('Pge',null,null,'','1px solid ','','l','Century Gothic','','','','');
        Yii::$app->reporter->endrow();
...
Yii::$app->reporter->endtable();
    ...
    Yii::$app->reporter->endrow();
    Yii::$app->reporter->startrow('',null,'','1px solid ','','','','Century Gothic','B','10','','');
