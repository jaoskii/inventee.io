...
$this->title = 'Cash Receipt Book - Summary';
?>
...
Yii::$app->reporter->begintable('800',null,'','1px solid ','','','Century Gothic','','','','');
        ...
        Yii::$app->reporter->col('SUMMARIZED CASH RECEIPT BOOK',null,null,'','1px solid ','','l','Century Gothic','18','b','','');
...
Yii::$app->reporter->begintable('800',null,'','1px solid ','','','','','','','');
        ...
        Yii::$app->reporter->startrow('',null,'','1px solid ','','','Century Gothic','B','b','','');
...
Yii::$app->reporter->startrow('',null,'50','1px solid ','','B','Century Gothic','B','11','','');
    ...
    Yii::$app->reporter->startrow('',null,'','1px solid ','','B','Century Gothic','B','12','','');
                 ...
                 Yii::$app->reporter->col('',null,null,'','1px solid ','T','c','','Century Gothic','b','','');
