...
$this->title = 'Journal Voucher - Detailed';
?>
...
Yii::$app->reporter->begintable('800',null,'','1px solid ','','','Century Gothic','','','','');
        ...
        Yii::$app->reporter->col('DETAILED JOURNAL VOUCHER',null,null,'','1px solid ','','l','Century Gothic','18','b','','');
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
                 ...
                 Yii::$app->reporter->col('PAYEE NAME PARTICULARS',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('DATE',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
                 Yii::$app->reporter->col('ACCNT CODE',null,null,'','1px solid ','B','l','Century Gothic','10','B','','');
