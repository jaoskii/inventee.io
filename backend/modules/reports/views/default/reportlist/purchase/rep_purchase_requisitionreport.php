...
$this->title = 'Purchase Requisition Report';
?>
...
// var_dump($params);
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Purchase Requisition Report',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
for($i=0;$i<count($data);$i++)
{
    ...
    if($docno=="" || $docno!=$data[$i]['docno']) 
    {
        ...
        Yii::$app->reporter->begintable('1000');
            ...
            //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
                ...
                Yii::$app->reporter->col('Reference','100',null,false,'1px solid ','B','C','Century Gothic','11','B','30px','8px');
    ...
    Yii::$app->reporter->begintable('1000');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col(number_format($data[$i]['rrqty'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'70',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
            ...
            Yii::$app->reporter->col($data[$i]['ref'],'100',null,false,'1px solid ','','C','Century Gothic','11','','30px','8px');
