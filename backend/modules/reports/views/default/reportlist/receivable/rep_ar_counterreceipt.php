...
$this->title = 'Counter Receipt List';
?>
...
$start=$params['start'];
 ...
 Yii::$app->reporter->startrow();           
    Yii::$app->reporter->col('Counter Receipt List','1000',null,false,'1px dotted','','','Century Gothic','18','B','30px','8px');
...
for($i=0;$i<count($data);$i++)
{
    ...
    if($docno=="" || $docno!=$data[$i]['docno']) 
    {
        ...
        Yii::$app->reporter->col('<b>'.'Date: '.'</b>'.$data[$i]['hdateid'],'100',null,false,'1px solid ','','','Century Gothic','10','','','2px');
        Yii::$app->reporter->col('','100',null,false,'1px dotted','','R','Century Gothic','14','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px dotted','','R','Century Gothic','14','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px dotted','','R','Century Gothic','14','B','30px','8px');
        Yii::$app->reporter->col('','100',null,false,'1px dotted','','R','Century Gothic','14','B','30px','8px');
    ...
    Yii::$app->reporter->begintable('1000');
        Yii::$app->reporter->startrow();
            Yii::$app->reporter->col($data[$i]['ddateid'],'100',null,false,'10px solid ','','C','Century Gothic','10','','','');
