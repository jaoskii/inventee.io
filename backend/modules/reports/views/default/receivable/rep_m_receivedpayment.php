...
$this->title = 'Received Payment Report';
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('RECEIVED PAYMENT','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('','75',null,false,'1px solid ','','C','Century Gothic','12','','','2px');

        Yii::$app->reporter->col('Check # : ','50',null,false,'1px solid ','','R','Century Gothic','12','i','','2px');
        for($c=0;$c<count($data);$c++){
        Yii::$app->reporter->col($data[$c]['checkno'],'50',null,false,'1px solid ','','L','Century Gothic','12','','','2px');
}
        Yii::$app->reporter->col('','75',null,false,'1px solid ','','C','Century Gothic','12','','','2px');
        Yii::$app->reporter->col('','75',null,false,'1px solid ','','C','Century Gothic','12','','','2px');
        Yii::$app->reporter->col('','75',null,false,'1px solid ','','C','Century Gothic','12','','','2px');
