...
echo '<div id="details" style="height:60px;clear:both;">';
    ...
    Yii::$app->reporter->begintable('750');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col(' ','20',null,false,'1px solid ','','L','Arial','10','B','20px','3px');
            Yii::$app->reporter->col(''.(isset($data[0]['terms'])? $data[0]['terms']:''),'30',null,false,'1px solid ','','R','Arial','10','B','30px','3px');
            Yii::$app->reporter->col('','250',null,false,'1px solid ','','R','Arial','10','B','30px','3px');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
    ...
    Yii::$app->reporter->begintable('750');
        Yii::$app->reporter->startrow();
            Yii::$app->reporter->col('','150',null,false,'1px solid ','','L','Arial','10','B','30px','3px');
            Yii::$app->reporter->col(''.(isset($data[0]['address'])? $data[0]['address']:''),'450',null,false,'1px solid ','','L','Arial','10','B','320px','3px');
