...
echo '<div id="details" style="height:350px;clear:both;">';
    ...
    for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(''.$data[$i]['itemname'],'370',null,false,'1px solid ','','L','Arial','10','B','','2px');
        Yii::$app->reporter->col(number_format($data[$i]['amt'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'125',null,false,'1px solid ','','R','Arial','10','B','','2px');
        Yii::$app->reporter->col('','195',null,false,'1px solid ','','R','Arial','10','B','','2px');
