...
echo '<div id="details" style="margin-top:-20px;height:350px;clear:both;">';
    ...
    for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(''.$data[$i]['uom'],'100',null,false,'1px solid ','','C','Arial','10','B','15px','2px');
        Yii::$app->reporter->col(''.$data[$i]['itemname'],'430',null,false,'1px solid ','','L','Arial','10','B','15px','2px');
        Yii::$app->reporter->col(''.number_format($data[$i]['amt'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'90',null,false,'1px solid ','','R','Arial','10','B','15px','2px');
        Yii::$app->reporter->col('','70',null,false,'1px solid ','','R','Arial','10','B','15px','2px');
