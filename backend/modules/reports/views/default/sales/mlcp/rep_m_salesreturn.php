...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('SALES RETURN','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col((isset($data[0]['address'])? $data[0]['address']:''),'540',null,false,'1px solid ','B','L','Century Gothic','12','','30px','4px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('REF NO','125px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['ref'],'125px',null,false,'1px solid ','','C','Century Gothic','12','B','30px','8px');
