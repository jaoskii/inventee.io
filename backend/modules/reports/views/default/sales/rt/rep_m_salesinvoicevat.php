...
echo '</div><br/>';
    ...
    Yii::$app->reporter->begintable('720');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','50',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col('','10',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col(number_format($sales,2),'210',null,false,'1px dotted ','','R','Verdana','12','','30px','1px');
        Yii::$app->reporter->col('','60',null,false,'1px dotted ','','C','Verdana','12','','','');
    ...
    Yii::$app->reporter->begintable('720');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','50',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col('','220',null,false,'1px dotted ','','R','Verdana','12','','30px','1px');
        Yii::$app->reporter->col('','60',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col(number_format($tax,2),'60',null,false,'1px dotted ','','C','Verdana','12','','30px','1px');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
    ...
    Yii::$app->reporter->begintable('720');
        ...
        Yii::$app->reporter->col('','220',null,false,'1px dotted ','','R','Verdana','12','','30px','1px');
        Yii::$app->reporter->col('','60',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col(number_format($sales,2),'60',null,false,'1px dotted ','','C','Verdana','12','','30px','1px');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
    ...
    Yii::$app->reporter->begintable('720');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','50',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col(number_format($tax,2),'210',null,false,'1px dotted ','','R','Verdana','12','','30px','1px');
        Yii::$app->reporter->col('','60',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col('','60',null,false,'1px dotted ','','L','Verdana','12','','','');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
    ...
    Yii::$app->reporter->begintable('720');
        ...
        Yii::$app->reporter->col('','220',null,false,'1px dotted ','','R','Verdana','12','','30px','1px');
        Yii::$app->reporter->col('','60',null,false,'1px dotted ','','C','Verdana','12','','','');
        Yii::$app->reporter->col(number_format($totalext,2),'60',null,false,'1px dotted ','','C','Verdana','12','','30px','1px');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
