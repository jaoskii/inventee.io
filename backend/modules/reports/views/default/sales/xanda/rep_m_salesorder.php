...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col((isset($data[0]['salesman'])? $data[0]['salesman']:''),'500',null,false,'1px solid ','B','L','Century Gothic','12','','30px','4px');
        Yii::$app->reporter->col('','220',null,false,'1px solid ','','L','Century Gothic','12','','30px','4px');
...
Yii::$app->reporter->begintable('800');
   ...
   $totalext=0;
   $totalton = 0;
   $totalton=$totalton+$data[0]['gtonage'];  
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(number_format($data[$i]['qty'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'30px',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['uom'],'50px',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Tonnage','50px',null,false,'1px dotted ','T','C','Century Gothic','12','B','','');
        Yii::$app->reporter->col($totalton,'50px',null,false,'1px dotted ','T','C','Century Gothic','12','B','','');
