...
$rep->begintable('800');
        ...
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        $rep->col('&nbsp;&nbsp;&nbsp;&nbsp;','50',null,false,'1px solid ','','L','Courier New','12','','','');
        $rep->col('Ship / Deliver To:&nbsp;&nbsp;'.(isset($data[0]['shipto'])? $data[0]['shipto']:''),'525',null,false,'1px solid ','','L','Courier New','12','','','');
        $rep->col('','100',null,false,'1px solid ','','L','Courier New','12','B','','');
        $rep->col('','130',null,false,'1px solid ','','R','Courier New','12','','','').'<br />';
        $rep->endrow();
$rep->endtable();
...
for($i=0;$i<count($data);$i++){
        ...
        $rep->col(strtolower($data[$i]['uom']),'50',null,false,'1px dotted','','C','Courier New','12','','','2px');
...
$rep->begintable('800');
        ...
        $rep->col(number_format($totalext,2),'125px',null,false,'1px dotted ','','R','Courier New','14','','','');
        $rep->endrow();
$rep->endtable();
$rep->begintable('800');
        $rep->startrow();
        ...
        $rep->col('','125px',null,false,'1px dotted ','','C','Courier New','12','B','','');
        $rep->col('','50px',null,false,'1px dotted ','','R','Courier New','12','B','','');
        $rep->col('<br>','125px',null,false,'1px dotted ','','R','Courier New','14','','','');
        $rep->endrow();
$rep->endtable();  
$rep->begintable('800');
        $rep->startrow();
