...
$this->title = 'Sales Invoice - A Report';
?>
...
for($i=0;$i<count($data);$i++){
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col($data[$i]['itemname'],'600',null,false,'1px dotted ','','L','Courier New','10','','','');
        //Yii::$app->reporter->col($data[$i]['sizeid'],'100',null,false,'1px dotted','','L','Courier New','10','','','');
        Yii::$app->reporter->col(number_format($data[$i]['qty'],2),'75',null,false,'1px dotted','','R','Courier New','10','','','');
        Yii::$app->reporter->col(strtolower($data[$i]['uom']),'50',null,false,'1px dotted','','C','Courier New','10','','',''); //2px
        Yii::$app->reporter->col(number_format($data[$i]['amt'],2),'100',null,false,'1px dotted','','R','Courier New','10','','','');
        Yii::$app->reporter->col($data[$i]['disc'],'100',null,false,'1px dotted','','C','Courier New','10','','','');
        Yii::$app->reporter->col('        '.number_format($data[$i]['ext'],2),'100',null,false,'1px dotted','','R','Courier New','10','','','');
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col(number_format($sales,2),'125px',null,false,'1px dotted ','','R','Courier New','14','','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('','125px',null,false,'1px dotted ','','C','Courier New','12','B','','');
        Yii::$app->reporter->col('','50px',null,false,'1px dotted ','','R','Courier New','12','B','','');
        Yii::$app->reporter->col(number_format($tax,2),'125px',null,false,'1px dotted ','','R','Courier New','14','','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();  
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
