...
echo '<br/><br/>';
    ...
    Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col($data[0]['tel'].$data[0]['tel2'].$data[0]['fax'],'520',null,false,'1px solid ','B','L','Century Gothic','12','','30px','4px');
            Yii::$app->reporter->col('OURREF','50',null,false,'1px solid ','','L','Century Gothic','12','B','','');
...
Yii::$app->reporter->endtable();
    ...
    Yii::$app->reporter->col('GRAND TOTAL : ','125px',null,false,'1px dotted ','T','C','Century Gothic','12','B','','');
