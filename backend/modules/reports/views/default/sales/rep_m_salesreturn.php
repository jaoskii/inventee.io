...
$this->title = 'Sales Return Report';
?>
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('SALES RETURN','600',null,false,'1px solid ','','L','Helvetica','18','B','','');
        Yii::$app->reporter->col('DOC NO :','80',null,false,'1px solid ','','L','Helvetica','13','B','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col((isset($data[0]['dateid'])? $data[0]['dateid']:''),'120',null,false,'1px solid ','B','R','Helvetica','12','','','');
    Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('QTY','50px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('UNIT','50px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('D E S C R P T I O N','500px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('NET PRICE','125px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        // Yii::$app->reporter->col('(+/-) %','50px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('TOTAL','125px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(number_format($data[$i]['amt']*(1-($data[$i]['disc'])/100),Yii::$app->systemsettings->setDecimaldisplay('currency')),'125px',null,false,'1px solid ','','R','Helvetica','14','','','2px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col((isset($data[0]['address'])? $data[0]['address']:''),'540',null,false,'1px solid ','B','L','Helvetica','12','','30px','4px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('UNIT','50px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('D E S C R P T I O N','500px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('UNIT PRICE','125px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('(+/-) %','50px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->col('TOTAL','125px',null,false,'1px solid ','B','C','Helvetica','12','B','30px','8px');
        Yii::$app->reporter->endrow();
               Yii::$app->reporter->printline();
        ...
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','50px',null,false,'1px dotted ','T','C','Helvetica','12','B','','');
        Yii::$app->reporter->col('','50px',null,false,'1px dotted ','T','C','Helvetica','12','B','','');
        Yii::$app->reporter->col('','500px',null,false,'1px dotted ','T','C','Helvetica','12','B','','');
        // Yii::$app->reporter->col('','125px',null,false,'1px dotted ','T','C','Helvetica','12','B','','');
        Yii::$app->reporter->col('GRAND TOTAL :','50px',null,false,'1px dotted ','T','R','Helvetica','13','B','','');
        Yii::$app->reporter->col(number_format($totalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'125px',null,false,'1px dotted ','T','R','Helvetica','15','B','','');
        Yii::$app->reporter->endrow();
    ...
    Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col((isset($data[0]['rem'])? $data[0]['rem']:''),'600',null,false,'1px solid ','','L','Helvetica','12','','','');
        Yii::$app->reporter->col('','150',null,false,'1px solid ','','L','Helvetica','12','B','','');
    ...
    Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('Prepared By : ','266',null,false,'1px solid ','','L','Helvetica','12','BI','','');
        Yii::$app->reporter->col('Picked By :','266',null,false,'1px solid ','','L','Helvetica','12','BI','','');
        Yii::$app->reporter->col('Checked By :','266',null,false,'1px solid ','','L','Helvetica','12','BI','','');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
    ...
    Yii::$app->reporter->begintable('800');
        ...
        // Yii::$app->reporter->col($received,'266',null,false,'1px solid ','','C','Helvetica','12','B','','');
        // Yii::$app->reporter->col($approved,'266',null,false,'1px solid ','','R','Helvetica','12','B','','');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
