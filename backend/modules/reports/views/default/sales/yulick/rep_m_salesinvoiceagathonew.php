...
echo '<br/><br/><br/><br/><br/>';
echo '<div id="details" style="margin-top:-4px;height:65px;clear:both;">';
    Yii::$app->reporter->begintable('750');
        Yii::$app->reporter->startrow();
            Yii::$app->reporter->col('','100',null,false,'1px solid ','','L','Arial Rounded MT Bold','10','B','30px','');
            Yii::$app->reporter->col(''.(isset($data[0]['clientname'])? $data[0]['clientname']:''),'330',null,false,'1px solid ','','L','Arial','10','B','30px','2px');
...
echo '</div>';    
echo '<div id="details" style="margin-top:-7px;height:350px;clear:both;">';
    ...
    for($i=0;$i<count($data);$i++){
        ...
        if ($pqty =='1'){
            Yii::$app->reporter->col(number_format($data[$i]['qty2'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'50',null,false,'1px solid ','','R','Arial','10','B','','1.5px');
        } else {
            Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Arial','10','B','','1.5px');
        }
        //Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Arial','10','B','','1px');
        Yii::$app->reporter->col(''.$data[$i]['uom'],'80',null,false,'1px solid ','','C','Arial','10','B','','1.5px');
        Yii::$app->reporter->col(''.$data[$i]['itemname'],'240',null,false,'1px solid ','','L','Arial','10','B','','1.5px');
        Yii::$app->reporter->col(number_format($data[$i]['amt'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'80',null,false,'1px solid ','','R','Arial','10','B','','1.5px');
        Yii::$app->reporter->col('','320',null,false,'1px solid ','','R','Arial','10','B','','1.5px');
