...
echo '<br/><br/><br/><br/><br/>';
echo '<div id="details" style="margin-top:-8px;height:75px;clear:both;">';
...
echo '<br/>';
    ...
    for($i=0;$i<count($data);$i++){
        ...
        if ($pqty =='1'){
            Yii::$app->reporter->col(number_format($data[$i]['qty2'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'50',null,false,'1px solid ','','C','Arial','10','B','','1px');
        } else {
            Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Arial','10','B','','1px');
        }
        //Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Arial','10','B','','');
        Yii::$app->reporter->col(''.$data[$i]['uom'],'70',null,false,'1px solid ','','R','Arial','10','B','','1px');
        Yii::$app->reporter->col('&nbsp;&nbsp;&nbsp;'.$data[$i]['itemname'],'270',null,false,'1px solid ','','L','Arial','10','B','','1px');
        Yii::$app->reporter->col(''.number_format($data[$i]['amt'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'80',null,false,'1px solid ','','C','Arial','10','B','','1px');
