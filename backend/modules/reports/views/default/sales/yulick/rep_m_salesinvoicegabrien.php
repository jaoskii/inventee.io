...
echo '<br/><br/><br/>';
echo '<div id="details" style="margin-top:5px;height:70px;clear:both;">';
...
echo '<div id="details" style="margin-top:-20px;height:350px;clear:both;">';
    ...
    for($i=0;$i<count($data);$i++){
        ...
        if ($pqty =='1'){
            Yii::$app->reporter->col(number_format($data[$i]['qty2'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'30',null,false,'1px solid ','','L','Arial','10','B','','');
            } else {
        ...
        Yii::$app->reporter->col(''.$data[$i]['itemname'],'450',null,false,'1px solid ','','L','Arial','10','B','','');
        Yii::$app->reporter->col(number_format($data[$i]['amt'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'160',null,false,'1px solid ','','R','Arial','10','B','','');
        Yii::$app->reporter->col('','40',null,false,'1px solid ','','R','Arial','10','B','','');
