...
echo '<br/>';
   ...
   $totalext=0;
    for($i=0;$i<count($data);$i++){
        ...
        if ($pqty ==1){
            Yii::$app->reporter->col(number_format($data[$i]['qty2'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'50px',null,false,'1px solid ','LRTB','C','Century Gothic','10','','','2px');
        } else {
