...
$this->title = 'China Check';

//WTODO: [KIM][2019.11.25][check- chinabank layout]
?>
...
echo '<div style="margin-top:-2px;letter-spacing: 5px;">';
...
Yii::$app->reporter->begintable('920');
            ...
            Yii::$app->reporter->col('&nbsp','180',null,false,'1px solid ','','L','Verdana','11','','30px','4px');
...
Yii::$app->reporter->begintable('920');
            ...
            Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Verdana','13','B','30px','4px');
            Yii::$app->reporter->col('','670',null,false,'1px solid ','','L','Verdana','10','','30px','4px');
            Yii::$app->reporter->col((''.isset($cdate)? $cdate:''),'180',null,false,'1px solid ','','L','Verdana','11','','30px','4px');
            Yii::$app->reporter->col('','120',null,false,'1px solid ','','C','Verdana','13','B','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('920');
            Yii::$app->reporter->startrow();
            Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Verdana','13','B','30px','4px');
            Yii::$app->reporter->col($client2,'720',null,false,'1px solid ','','L','Verdana','11','','30px','4px');
            Yii::$app->reporter->col((isset($cc)? number_format($cc,Yii::$app->systemsettings->setDecimaldisplay('currency')):''),'150',null,false,'1px solid ','','C','Verdana','11','','30px','4px');
...
Yii::$app->reporter->begintable('920');
            ...
            Yii::$app->reporter->startrow();
            Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Verdana','13','B','30px','4px');
            Yii::$app->reporter->col(Yii::$app->backend->ftNumberToWordsConverter($dd). ' PESOS ONLY','900',null,false,'1px solid ','','L','Verdana','11','','30px','4px');
