...
//WTODO: [KIM][2019.11.22][update layout][cash check voucher layout]
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('DATE : ','90',null,false,'1px solid ','','L','Century Gothic','12','B','','');
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('REFERENCE # :','100',null,false,'1px solid ','','L','Century Gothic','12','B','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('CHECK DETAILS','100',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['checkno'],'100',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['invoiceno'],'100',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
