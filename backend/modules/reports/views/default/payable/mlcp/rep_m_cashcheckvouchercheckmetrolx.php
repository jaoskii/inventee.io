...
//WTODO: [KIM][2019.11.20][check- metrobank layout]
?>
...
echo '<div style="margin-top:20px;letter-spacing: 5px;">';
...
Yii::$app->reporter->begintable('920');
            ...
            Yii::$app->reporter->col((isset($cdate)? $cdate:''),'180',null,false,'1px solid ','','R','Verdana','12','B','30px','4px');
            Yii::$app->reporter->col('','20',null,false,'1px solid ','','C','Verdana','13','B','','');
...
Yii::$app->reporter->begintable('920');
            Yii::$app->reporter->startrow();
            Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Verdana','13','B','30px','4px');
            Yii::$app->reporter->col("<div style='margin-left:-60px;'>".$client2."</div>",'720',null,false,'1px solid ','','L','Verdana','12','B','30px','4px');
            Yii::$app->reporter->col((isset($cc)? number_format($cc,Yii::$app->systemsettings->setDecimaldisplay('currency')):''),'150',null,false,'1px solid ','','C','Verdana','12','B','30px','4px');
...
Yii::$app->reporter->begintable('920');
            ...
            Yii::$app->reporter->startrow();
            Yii::$app->reporter->col('','50',null,false,'1px solid ','','C','Verdana','13','B','30px','4px');
            Yii::$app->reporter->col("<div style='margin-left:-90px;'>".Yii::$app->backend->ftNumberToWordsConverter($dd). ' ONLY'.'</div>','900',null,false,'1px solid ','','L','Verdana','12','B','30px','4px');
