...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('ACCOUNT NAME','150',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('CHECK DETAILS','150',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('REF','100',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['acnoname'],'150',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['checkno'],'150',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['ref'],'100',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->begintable('800');
            Yii::$app->reporter->startrow();
                ...
                Yii::$app->reporter->col('','50',null,false,'1px dotted ','T','R','Century Gothic','12','B','30px','2px');
                Yii::$app->reporter->col('GRAND TOTAL :','125',null,false,'1px dotted ','T','R','Century Gothic','12','B','30px','2px');
                ...
                Yii::$app->reporter->col('','100',null,false,'1px dotted ','T','C','Century Gothic','12','B','','2px');
            Yii::$app->reporter->endrow();
        Yii::$app->reporter->endtable();
