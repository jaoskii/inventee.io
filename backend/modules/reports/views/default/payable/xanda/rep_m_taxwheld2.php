...
Yii::$app->reporter->begintable('800');
        ...
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('','20',null,false,'1px solid ','','L','Avenir','12','','','');
        Yii::$app->reporter->col('RT TRADING','480',null,false,'1px solid ','','L','Avenir','12','','','');
        Yii::$app->reporter->col('','20',null,false,'1px solid ','','L','Avenir','12','','','');
        Yii::$app->reporter->col('112-625-341-000','280',null,false,'1px solid ','','L','Avenir','12','','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','20',null,false,'1px solid ','','L','Avenir','12','','','');
        Yii::$app->reporter->col(strtoupper('Warehouse #7, Madrigal Compound S. Osmeña Boulevard, <br>
        Pier 1 Area Cebu City, Philippines 6000'),'780',null,false,'1px solid ','','L','Avenir','12','','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
