...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('REFERENCE #','100',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('','75',null,false,'1px dotted ','T','C','Century Gothic','12','B','','2px');
        Yii::$app->reporter->col('','400',null,false,'1px dotted ','T','R','Century Gothic','12','B','30px','2px');
