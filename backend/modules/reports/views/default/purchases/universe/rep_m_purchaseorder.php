...
if($potype == 'barcode'){
    ...
    $this->title = 'Purchase Order Report (Supp Item Code)';
}//end if
?>
...
Yii::$app->reporter->begintable('800');
        ...
        if($potype == 'barcode'){
            ...
            Yii::$app->reporter->col('PURCHASE ORDER (Supp Item Code)','580',null,false,'1px solid ','','L','Century Gothic','18','B','','');
        }//end if
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i][$potype],'50',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
