...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('PURCHASE RETURN','580',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('SUPPLIER : ','90',null,false,'1px solid ','','L','Century Gothic','12','B','30px','4px');
        Yii::$app->reporter->col((isset($data[0]['clientname'])? $data[0]['clientname']:''),'510',null,false,'1px solid ','B','L','Century Gothic','12','','30px','4px');
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('ADDRESS : ','90',null,false,'1px solid ','','L','Century Gothic','12','B','30px','4px');
        Yii::$app->reporter->col((isset($data[0]['address'])? $data[0]['address']:''),'510',null,false,'1px solid ','B','L','Century Gothic','12','','30px','4px');
        Yii::$app->reporter->col('WAREHOUSE: ','50',null,false,'1px solid ','','L','Century Gothic','12','B','','');
        Yii::$app->reporter->col((isset($data[0]['wh'])? $data[0]['wh']:''),'150',null,false,'1px solid ','B','R','Century Gothic','12','','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('BARCODE','80px',null,false,'1px solid ','B','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('D E S C R P T I O N','500px',null,false,'1px solid ','B','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('REF INV','50px',null,false,'1px solid ','B','L','Century Gothic','12','B','30px','8px');\
        Yii::$app->reporter->col('EXPIRY','25px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['barcode'],'80px',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['itemname'],'500px',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['ref'],'50px',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['expiry'],'50px',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('','140',null,false,'1px solid ','','R','Century Gothic','12','','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('','50px',null,false,'1px dotted ','T','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('BATCH : ','50px',null,false,'1px dotted ','T','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('','80px',null,false,'1px dotted ','T','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('','500px',null,false,'1px dotted ','T','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col(' ','50px',null,false,'1px dotted ','T','L','Century Gothic','12','B','30px','8px');\
        Yii::$app->reporter->col('','25px',null,false,'1px dotted ','T','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col(' ','125px',null,false,'1px dotted ','T','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('GRAND TOTAL :','50px',null,false,'1px dotted ','T','R','Century Gothic','11','B','','');
        Yii::$app->reporter->col(number_format($totalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'125px',null,false,'1px dotted ','T','R','Century Gothic','11','B','','');
        Yii::$app->reporter->endrow();
    ...
    Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('NOTE : ','50',null,false,'1px solid ','','L','Century Gothic','12','B','','');
        Yii::$app->reporter->col($data[0]['rem'],'590',null,false,'1px solid ','','L','Century Gothic','12','','','');
