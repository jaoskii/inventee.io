...
$this->title = 'Detailed Purchases - Transaction Report';
?>
...
//header
    ...
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('Detailed Purchases - Transaction Report',null,null,false,'1px solid ','','','Helvetica','18','B','','').'<br />';
    ...
    Yii::$app->reporter->endrow();
    Yii::$app->reporter->startrow(NULL,null,false,'1px solid ','','R','Helvetica','10','','30px','5px');
        Yii::$app->reporter->col('Warehouse: ' . (($params['wh'] != "") ? $params['wh'] : "ALL"),null,null,false,'1px solid ','','','Helvetica','10','B','','');
    Yii::$app->reporter->endrow();
    Yii::$app->reporter->startrow(NULL,null,false,'1px solid ','','R','Helvetica','10','','30px','5px');
        Yii::$app->reporter->col('Vat Type: ' . strtoupper($params['vattype']) ,null,null,false,'1px solid ','','','Helvetica','10','B','','');
    Yii::$app->reporter->endrow();
    Yii::$app->reporter->startrow(NULL,null,false,'1px solid ','','R','Helvetica','10','','30px','5px');
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->begintable('2400');
        Yii::$app->reporter->startrow();
            ...
            Yii::$app->reporter->col(number_format($data[$i]['rrqty'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'100',null,false,'1px solid ','','C','Helvetica','11','','30px','8px');
            Yii::$app->reporter->col(number_format($data[$i]['rrcost'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'100',null,false,'1px solid ','','C','Helvetica','11','','30px','8px');
            ...
            if($data[$i]['rrqty'] == 0){
                ...
                Yii::$app->reporter->col(number_format($data[$i]['cost'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'100',null,false,'1px solid ','','R','Helvetica','11','','30px','8px');
            }//end if
