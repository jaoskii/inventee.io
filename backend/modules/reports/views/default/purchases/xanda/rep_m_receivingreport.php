...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('WH','50px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['wh'],'50px',null,false,'1px solid ','','C','Century Gothic','11','','','');
        ...
        if(Yii::$app->backend->viewcostAccess()){
            Yii::$app->reporter->col($netamt,'125px',null,false,'1px solid ','','R','Century Gothic','11','','','2px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col(number_format($totalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'125px',null,false,'1px dotted ','T','R','Century Gothic','12','B','','');
            ...
            Yii::$app->reporter->col('-','125px',null,false,'1px dotted ','T','R','Century Gothic','12','B','','');
        }//end if
        ...
        Yii::$app->reporter->col('','125px',null,false,'1px dotted ','','C','Century Gothic','12','B','','');
        Yii::$app->reporter->col('','125px',null,false,'1px dotted ','','C','Century Gothic','12','B','','');
       Yii::$app->reporter->col('NET OF DISC :','50px',null,false,'1px dotted ','','R','Century Gothic','12','B','','');

        if(Yii::$app->backend->viewcostAccess()){
        Yii::$app->reporter->col(number_format($totalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'125px',null,false,'1px dotted ','','R','Century Gothic','12','B','','');
        }else{
            Yii::$app->reporter->col('-','125px',null,false,'1px dotted ','T','R','Century Gothic','12','B','','');
        }//end if
        Yii::$app->reporter->endrow();
