...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('SERVICE RECEIVING REPORT','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('PO # : ','50',null,false,'1px solid ','','L','Century Gothic','12','B','','');
        Yii::$app->reporter->col((isset($data[0]['docno'])? $data[0]['docno']:''),'150',null,false,'1px solid ','B','R','Century Gothic','12','','','');
        Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('BAROCDE','50px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('UNIT','50px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('D E S C R I P T I O N','400px',null,false,'1px solid ','B','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('UNIT PRICE','125px',null,false,'1px solid ','B','R','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('DISC','50px',null,false,'1px solid ','B','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('TOTAL','125px',null,false,'1px solid ','B','R','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['barcode'],'50px',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
        ...
        Yii::$app->reporter->col(number_format($data[$i]['netamt'],Yii::$app->systemsettings->setDecimaldisplay('unitprice')),'125px',null,false,'1px solid ','','R','Century Gothic','11','','','2px');
        Yii::$app->reporter->col($data[$i]['disc'],'50px',null,false,'1px solid ','','L','Century Gothic','11','','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
      ...
      Yii::$app->reporter->col('QTY','50px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
        ...
        Yii::$app->reporter->col('','50px',null,false,'1px solid ','T','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('','50px',null,false,'1px solid ','T','C','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('','400px',null,false,'1px solid ','T','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col(' ','125px',null,false,'1px solid ','T','R','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col('GRAND TOTAL :','50px',null,false,'1px solid ','T','L','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->col(number_format($totalext,Yii::$app->systemsettings->setDecimaldisplay('currency')),'125px',null,false,'1px solid ','T','R','Century Gothic','12','B','30px','8px');
        Yii::$app->reporter->endrow();
