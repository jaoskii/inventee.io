...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('EXPIRY','100px',null,false,'1px solid ','B','L','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['expiry'],'100px',null,false,'1px solid ','','L','Century Gothic','11','','','2px');
        Yii::$app->reporter->col(number_format($data[$i]['gross'],Yii::$app->systemsettings->setDecimaldisplay('unitprice')),'125px',null,false,'1px solid ','','R','Century Gothic','11','','','2px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
      ...
      Yii::$app->reporter->col('QTY','50px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
        ...
        Yii::$app->reporter->col('','100px',null,false,'1px solid ','T','L','Century Gothic','12','B','30px','8px');
