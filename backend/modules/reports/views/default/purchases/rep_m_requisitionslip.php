...
$this->title = 'Requisition Slip Report';
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('REQUISITION SLIP','580',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('SUPPLIER : ','100',null,false,'1px solid ','','L','Century Gothic','12','B','30px','4px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(number_format($data[$i]['rrqty'],Yii::$app->systemsettings->setDecimaldisplay('quantity')),'100',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
        ...
        Yii::$app->reporter->col(number_format($data[$i]['qty'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'100',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
