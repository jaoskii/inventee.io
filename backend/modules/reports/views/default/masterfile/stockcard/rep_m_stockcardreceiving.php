...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('STACKCARD - RECEIVING ',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('800');
    ...
    Yii::$app->reporter->col('Supplier Name','175',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Exch Rate','100',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Purch. Cost','75',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Landed Cost','75',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Discount','50',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Qty','75',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Status','75',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->col($data[$i]['dateid'],'75',null,false,'1px solid ','','C','Century Gothic','10','','','');
    Yii::$app->reporter->col($data[$i]['clientname'],'175',null,false,'1px solid ','','L','Century Gothic','10','','','');
    Yii::$app->reporter->col(number_format($data[$i]['forex'],2),'100',null,false,'1px solid ','','C','Century Gothic','10','','','');
    Yii::$app->reporter->col(number_format($data[$i]['rrcost'],2),'75',null,false,'1px solid ','','C','Century Gothic','10','','','');
    Yii::$app->reporter->col(number_format($data[$i]['cost'],2),'75',null,false,'1px solid ','','C','Century Gothic','10','','','');
    Yii::$app->reporter->col($data[$i]['disc'],'50',null,false,'1px solid ','','C','Century Gothic','10','','','');
    Yii::$app->reporter->col(number_format($data[$i]['qty'],2),'75',null,false,'1px solid ','','C','Century Gothic','10','','','');
    Yii::$app->reporter->col($data[$i]['status'],'75',null,false,'1px solid ','','C','Century Gothic','10','','','');
    $totalqty=$totalqty+$data[$i]['qty'];
    $totalstatus=$totalstatus+$data[$i]['status'];
    Yii::$app->reporter->endrow();
}
Yii::$app->reporter->endtable();
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
    Yii::$app->reporter->col('','100',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('','50',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('','200',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Grand Total','100',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('','75',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('','75',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('','50',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col(number_format($totalqty,2),'75',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col(number_format($totalstatus,2),'75',null,false,'1px solid ','T','C','Century Gothic','11','B','','');
    Yii::$app->reporter->endrow();
Yii::$app->reporter->endtable();
