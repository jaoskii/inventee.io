...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('STACKCARD - SO ',null,null,false,'1px solid ','','','Century Gothic','18','B','','').'<br />';
...
Yii::$app->reporter->begintable('800');
    ...
    Yii::$app->reporter->col('Customer Name','400',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Ordered','100',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
    Yii::$app->reporter->col('Sold','100',null,false,'1px solid ','B','C','Century Gothic','11','B','','');
