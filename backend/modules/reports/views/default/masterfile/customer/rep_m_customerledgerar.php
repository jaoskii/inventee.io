...
$this->title = 'Customer Ledger Report - AR';
?>
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('CUSTOMER LEDGER - ACCOUNTS RECEIVABLE ',null,null,false,'1px solid ','','','Avenir','18','B','','').'<br />';
        Yii::$app->reporter->endrow();
...
Yii::$app->reporter->begintable('800');      
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('Customer:','50',null,false,'1px solid ','','L','Avenir','11','','','1px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
    Yii::$app->reporter->col('Document #','200',null,false,'1px solid ','B','C','Avenir','11','B','','');
    Yii::$app->reporter->col('Date','50',null,false,'1px solid ','B','C','Avenir','11','B','','');
    ...
    Yii::$app->reporter->col('Debit','100',null,false,'1px solid ','B','C','Avenir','11','B','','');
    Yii::$app->reporter->col('Credit','100',null,false,'1px solid ','B','C','Avenir','11','B','','');
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->startrow();
    Yii::$app->reporter->col($data[$i]['docno'],'200',null,false,'1px solid ','','L','Avenir','9','','','');
    Yii::$app->reporter->col($data[$i]['dateid'],'50',null,false,'1px solid ','','C','Avenir','9','','','');
    ...
    Yii::$app->reporter->col($debit,'100',null,false,'1px solid ','','R','Avenir','9','','','');
    Yii::$app->reporter->col($credit,'100',null,false,'1px solid ','','R','Avenir','9','','','');
    ...
    Yii::$app->reporter->startrow();
    Yii::$app->reporter->col('','200',null,false,'1px dotted ','T','L','Avenir','9','B','','3px');
    ...
    Yii::$app->reporter->col(number_format($totaldb,2),'100',null,false,'1px dotted ','T','R','Avenir','9','B','','3px');
    Yii::$app->reporter->col(number_format($totalcr,2),'100',null,false,'1px dotted ','T','R','Avenir','9','B','','3px');
