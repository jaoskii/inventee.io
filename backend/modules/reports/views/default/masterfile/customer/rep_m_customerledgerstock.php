...
$this->title = 'Customer Ledger Report - STOCKS';
?>
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('CUSTOMER LEDGER - INVENTORY ',null,null,false,'1px solid ','','','Verdana','18','B','','').'<br />';
        Yii::$app->reporter->endrow();
...
Yii::$app->reporter->begintable('800');
    ...
    Yii::$app->reporter->col('Unit','75',null,false,'1px solid ','B','C','Verdana','11','B','','');
    Yii::$app->reporter->col('Discount ','50',null,false,'1px solid ','B','C','Verdana','11','B','','');
    Yii::$app->reporter->col('Price','100',null,false,'1px solid ','B','C','Verdana','11','B','','');
...
for($i=0;$i<count($data);$i++){
    ...
    Yii::$app->reporter->startrow();
    Yii::$app->reporter->col($data[$i]['docno'],'100',null,false,'1px solid ','','C','Verdana','9','','','');
    ...
    Yii::$app->reporter->col($data[$i]['itemname'],'225',null,false,'1px solid ','','L','Verdana','9','','','');
    ...
    Yii::$app->reporter->col($cost,'100',null,false,'1px solid ','','R','Verdana','9','','','');
