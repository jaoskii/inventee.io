...
$this->title = 'Stock Transfer Report';
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('STOCK TRANSFER','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col(number_format($totalqty,Yii::$app->systemsettings->setDecimaldisplay('quantity')),'50px',null,false,'1px dotted ','T','R','Century Gothic','12','B','','');
