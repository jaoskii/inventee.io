...
//WTODO: [JLY][2019.08.23][KINGG CONCERNS][EDIT REPORT]
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('GENERAL JOURNAL','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('CUSTOMER/SUPPLIER: ','80',null,false,'1px solid ','','L','Century Gothic','12','B','30px','4px');
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col((isset($data[0]['hrem'])? $data[0]['hrem']:''),'520',null,false,'1px solid ','B','L','Century Gothic','12','','30px','4px');
        Yii::$app->reporter->col('REF. :','40',null,false,'1px solid ','','L','Century Gothic','12','B','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('NOTES','150',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col($data[$i]['drem'],'150',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col(number_format($totaldb,Yii::$app->systemsettings->setDecimaldisplay('currency')),'75',null,false,'1px dotted ','T','R','Century Gothic','12','B','','2px');
        Yii::$app->reporter->col(number_format($totalcr,Yii::$app->systemsettings->setDecimaldisplay('currency')),'75',null,false,'1px dotted ','T','R','Century Gothic','12','B','','2px');
        Yii::$app->reporter->col('','75',null,false,'1px dotted ','T','C','Century Gothic','12','B','','2px');
    ...
    Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('Noted By :','266',null,false,'1px solid ','','R','Century Gothic','12','','','');
        Yii::$app->reporter->endrow();
    Yii::$app->reporter->endtable();
