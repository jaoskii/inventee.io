...
$this->title = 'Production Completion Report';
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('PRODUCTION COMPLETION','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        //($txt='',$w=null,$h=null, $bg=false,$b=false,$b_='', $al='', $f='', $fs='',$fw='',$fc='',$pad='',$m='')
        Yii::$app->reporter->col('PLU','50px',null,false,'1px solid ','B','C','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(number_format($data[$i]['qty'],2),'50px',null,false,'1px solid ','','C','Century Gothic','11','','','2px');
        ...
        Yii::$app->reporter->col(number_format($data[$i]['gross'],2),'125px',null,false,'1px solid ','','R','Century Gothic','11','','','2px');
        Yii::$app->reporter->col(number_format($data[$i]['ext'],2),'125px',null,false,'1px solid ','','R','Century Gothic','11','','','2px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col(number_format($totalext,2),'125px',null,false,'1px dotted ','T','R','Century Gothic','12','B','','');
        Yii::$app->reporter->endrow();
    ...
    Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col((isset($data[0]['rem'])? $data[0]['rem']:''),'600',null,false,'1px solid ','','L','Century Gothic','12','','','');
