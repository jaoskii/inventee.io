...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('INVENTORY ADJUSTMENT','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(number_format($data[$i]['netamt'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'125px',null,false,'1px solid ','','R','Century Gothic','11','','','2px');
