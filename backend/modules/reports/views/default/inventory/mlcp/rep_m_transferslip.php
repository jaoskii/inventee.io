...
//WTODO: [KIM][2019.11.14][update layout for transfer slip printout]
?>
...
Yii::$app->reporter->begintable('800');
        ...
        Yii::$app->reporter->col('TRANSFER SLIP','600',null,false,'1px solid ','','L','Century Gothic','18','B','','');
...
Yii::$app->reporter->begintable('800');
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col('WAREHOUSE : ','90',null,false,'1px solid ','','L','Century Gothic','12','B','30px','4px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->col('QTY','50px',null,false,'1px solid ','B','R','Century Gothic','12','B','30px','8px');
        ...
        Yii::$app->reporter->col('COST','125px',null,false,'1px solid ','B','R','Century Gothic','12','B','30px','8px');
...
for($i=0;$i<count($data);$i++){
        ...
        Yii::$app->reporter->col(number_format($data[$i]['qty'],Yii::$app->systemsettings->setDecimaldisplay('currency')),'50px',null,false,'1px solid ','','R','Century Gothic','11','','','2px');
...
Yii::$app->reporter->begintable('800');
    Yii::$app->reporter->startrow();
        ...
        Yii::$app->reporter->startrow();
        Yii::$app->reporter->col(number_format($totalqty,Yii::$app->systemsettings->setDecimaldisplay('currency')),'50px',null,false,'1px dotted ','T','R','Century Gothic','12','B','','');
