...
<?php if($moduledata['head']['trno'] != null){?>
  ...
  if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
    ...
    <button type="button" style="display:none;" class="pop-btn btn-xx orderbtns btn btn-default btn-success stockbtn stock-btnPO" ><b><i class="fa fa-tags order_btn"></i></b></button>
    <div class="list">SJ</div>';
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      <button type="button" style="display:none;" class="orderbtns btn btn-default btn-success stockbtn stock-btnPO" ><b><i class="fa fa-tags order_btn"></i> SJ</b></button>';
                      ...
                      <button type="button" style="display:none;" class="orderbtns btn btn-default btn-success stockbtn 
                      stock-btnPO" ><b><i class="fa fa-tags order_btn"></i> SJ</b></button>
                      ';
                    }
                    ?>
                  ...
                  <?php }else{
                    ...
                    <button type="button" class="headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
                    <button type="button" class="headbtn module-btnunlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unlock_btn"></i> Unlock</b></button>
                    <button type="button" class="headbtn module-btnunpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-history lock_btn"></i> Unpost</b></button>
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs bg-green">
              ...
              switch (Yii::$app->systemsettings->companyConfig()) {
                case 'CANUMAY':
                  echo '<li class="">
                  <a class="clickable showdisc" aria-expanded="true" style="font-weight: bold;text-shadow: 0 1px 0 rgba(255, 255, 255, 0.5);">Set Discount</a>
                  </li>';
                break;
              }//end switch
              ?>
