...
<?php if($moduledata['head']['trno'] != null){?>
   <!-- ADD CLASS (pop-btn btn-xx ) to BUTTONS added here also Remove button captions -->  
    ...
    <button type="button" data-toggle="tooltip" title="Unprinted" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-info-circle unprintedlookup_btn"></i></b></button><div class="list">Unprinted</div>
    <!-- WTODO JAD 03-15-2019 -->
      ...
      <div class="box box-solid box-success">
              ...
              ?>
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    <!-- WTODO JAD 03-15-2019 -->
                    <button type="button" data-toggle="tooltip" title="Unprinted" class="btn btn-default btn-success headbtn btnactive module-btnunp"><b><i class="fa fa-info-circle unprintedlookup_btn"></i> Unprinted</b></button>
                    <!-- WTODO JAD 03-15-2019 -->
              ...
              <div class="box-body">
                ...
                <div class="input-group">
                 ...
                 <h6 class="aimslabel"><b>EWT Code:
                <div class="input-group">
                    <input name = "ewthead" value ="<?php if(isset($moduledata)){echo $moduledata['head']['ewt'];}?>" readonly type="text" class="moduletxt txtheadewt input-sm form-control"><div class=" input-group-addon"><a style="display:none;" class ="jlookupbtns headewtlookup" href="#"><i class="fa fa-chevron-circle-down"></i></a></div>

                     <input name = "ewtratehead" value ="<?php if(isset($moduledata)){echo $moduledata['head']['ewtrate'];}?>" readonly type="text" class="moduletxt hidden txtheadewtrateewt input-sm form-control">
                </div></h6>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                  <button style ="margin-bottom: 10px;font-weight: bold;" type="button" class="btn btn-xs btn-flat btn-github btn-sm btngenerateewt"><i class="fa fa-sort-amount-desc"></i>  GENERATE TAX / EWT ENTRIES
                  </button>
                  <div class="row">
                    <div class="col-md-12">
                      <?php 
