...
<?php if($moduledata['head']['trno'] != null){?>
  ...
  <!-- then add (<div class="list">CAPTION HERE</div>) after each </button> -->
  <!-- BEGIN BTN GROUP -->
...
<div class="list">Quickadd Item</div>
     ';
  }else{
    echo'<button type="button" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i></b></button>
<div class="list">Save All Items</div>
...
<div class="col-md-12">
      <div class="box box-solid box-success">
              ...
              ?>
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    <button type="button"  title="New transaction" class="btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> New</b></button>
                    <button type="button"  title="Save Transaction Head" class="btn btn-default btn-success headbtn module-btnsave" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save</b></button>
                     <?php
                      if($moduledata['head']['isposted']){
                      echo'<button type="button"  title="Edit Transaction" class="btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="fa fa-pencil edit_btn"></i> Edit</b></button>';
                      }else{
                        if($moduledata['head']['islocked']){
                         echo'<button type="button"  title="Edit Transaction" class="btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="fa fa-pencil edit_btn"></i> Edit</b></button>';
                        }else{
                        echo'<button type="button"  title="Edit Transaction" class="btn btn-default btn-success headbtn btnactive module-btnedit" style="display:block;"><b><i class="fa fa-pencil edit_btn"></i> Edit</b></button>';
                        }
                      }
                     ?>
                    <button type="button"  title="Cancel" class="btn btn-default btn-success headbtn module-btncancel" style="display:none;"><b><i class="fa fa-times cancel_btn"></i> Cancel</b></button>
                    <button type="button"  title="Print" class="btn btn-default btn-success headbtn btnactive module-btnprint"><b><i class="fa fa-print print_btn"></i> Print</b></button>
                    
                    <?php
                      if($moduledata['head']['isposted']){
                      echo'<button type="button"  title="Delete Transaction" class="headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                        <button type="button"  title="Lock Transaction" class="headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
                        <button type="button"  title="Unlock Transaction" class="headbtn module-btnunlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unlock_btn"></i> Unlock</b></button>
                        <button type="button"  title="Unpost Transaction" class="headbtn btnactive module-btnunpost btn btn-default btn-success" style="display:block;"><b><i class="fa fa-history unpost_btn"></i> Unpost</b></button>
                        <button type="button"  title="Post Transaction" class="headbtn module-btnpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check post_btn"></i> Post</b></button>';
                      }else{
                        if($moduledata['head']['islocked']){
                        echo'<button type="button"  title="Delete Transaction" class="headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                        <button type="button"  title="Lock Transaction" class="headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
                        <button type="button"  title="Unlock Transaction" class="headbtn btnactive module-btnunlock btn btn-default btn-success" style="display:block;"><b><i class="fa fa-unlock unlock_btn"></i> Unlock</b></button>';
                        }else{
                        echo'<button type="button"  title="Delete Transaction" class="headbtn btnactive module-btndelete btn btn-default btn-success"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                        <button type="button"  title="Lock Transaction" class="headbtn btnactive module-btnlock btn btn-default btn-success" style="display:block;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
                        <button type="button"  title="Unlock Transaction" class="headbtn module-btnunlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unlock_btn"></i> Unlock</b></button>';
                        }
                      echo'<button type="button"  title="Unpost Transaction" class="headbtn module-btnunpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-history unpost_btn"></i> Unpost</b></button>
                        <button type="button"  title="Post Transaction" class="headbtn btnactive module-btnpost btn btn-default btn-success" style="display:block;"><b><i class="fa fa-check post_btn"></i> Post</b></button>';
                      }
                     ?>

                     <button type="button"  title="Transaction Logs" class="btn btn-default btn-success headbtn btnactive module-btnlogs"><b><i class="fa fa-list logs_btn"></i> Logs</b></button>

                    <?php 
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      echo'<button type="button"  title="Save all  stock Items" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save Stock Items</b></button>
                      <button type="button"   title="Add New Item" class="btn btn-default btn-success stockbtn stock-btnadd" disabled="true"><b><i class="fa fa-plus add_btn"></i> Add Item</b></button>
                      <button type="button"   class="btn btn-default btn-success stockbtn stock-btn
                      " disabled="true"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b></button>
                       ';
                    }else{
                      echo'<button type="button"  title="Save all  stock Items" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save Stock Items</b></button>
                      <button type="button"   title="Add New Item" class="btn btn-default btn-success stockbtn stock-btnadd"><b><i class="fa fa-plus add_btn"></i> Add Item</b></button>
                  ...
                  <?php }else{
                    ...
                    <button type="button"  title="New transaction" class="btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> New</b></button>
                    <button type="button"  title="Save Transaction Head" class="btn btn-default btn-success headbtn module-btnsave" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save</b></button>
                    <button type="button"  title="Edit Transaction" class="btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="fa fa-pencil edit_btn"></i> Edit</b></button>
                    <button type="button"  title="Cancel" class="btn btn-default btn-success headbtn module-btncancel" style="display:none;"><b><i class="fa fa-times cancel_btn"></i> Cancel</b></button>
                    <button type="button"  title="Print" class="btn btn-default btn-success headbtn btnactive module-btnprint" style="display:none;"><b><i class="fa fa-print print_btn"></i> Print</b></button>
                    <button type="button"  title="Delete Transaction" class="headbtn module-btndelete btn btn-default btn-success" style="display:none;"><b><i class="fa fa-trash delete_btn"></i> Delete</b></button>
                    <button type="button"  title="Lock Transaction" class="headbtn module-btnlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-lock lock_btn"></i> Lock</b></button>
                    <button type="button"  title="Unlock Transaction" class="headbtn module-btnunlock btn btn-default btn-success" style="display:none;"><b><i class="fa fa-unlock unlock_btn"></i> Unlock</b></button>
                    <button type="button"  title="Unpost Transaction" class="headbtn module-btnunpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-history unpost_btn"></i> Unpost</b></button>
                    <button type="button"  title="Post Transaction" class="headbtn btnactive module-btnpost btn btn-default btn-success" style="display:none;"><b><i class="fa fa-check post_btn"></i> Post</b></button>
                    <button type="button"  title="Transaction Logs" class="btn btn-default btn-success headbtn btnactive module-btnlogs" style="display:none;"><b><i class="fa fa-list logs_btn"></i> Logs</b></button>
                    <button type="button"  title="Save all  stock Items" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save Stock Items</b></button>
                    <button type="button"   title="Add New Item" class="btn btn-default btn-success stockbtn stock-btnadd" disabled="true"><b><i class="fa fa-plus add_btn"></i> Add Item</b></button>
              ...
              <div class="box-body">
                ...
                <h6 class="aimslabel"><b>Trnx type:
                    <select disabled = "true" id="trnxtype" class="trnxtype input-sm form-control">
                    <?php if(isset($moduledata)){echo '<option>'.$moduledata['head']['trnxtype'] . '</option>';}?>
                    </select>
                </h6>
                ...
                <h6 class="aimslabel"><b>FG Barcode: <input value ="<?php if(isset($moduledata)){echo $moduledata['head']['mat_barcode'];}?>" type="text" class="txtmatbarcode form-control input-sm" disabled="true"></b></h6>
                </div><!-- /.col -->

                <div class="invoice-col col-md-3">
                  <h6 class="aimslabel dateidlookup" style="display:none;"><b>Required Date: <div data-date-viewmode="days" data-date-format="yyyy-mm-dd" data-date="<?php date('Y-m-d');?>"  class="paedit input-group date dpYears">
                  <div class="dateid-lookup input-group-addon add-on"><a href="#"><i class="fa fa-chevron-circle-down"></i></a></div>
                  <input type="text" name = "reqdate" readonly="" value="<?php if(isset($moduledata)){echo $moduledata['head']['reqdate'];}?>" size="12" class="moduletxt txtreqdateid form-control input-sm" disabled="true">
                </div></b></h6>

                  <h6 class="aimslabel dateidview"><b>Required Date:</b>
                  <input disabled="true" name="reqdateview" value ="<?php if(isset($moduledata)){echo $moduledata['head']['reqdate'];}?>" type="text" class="moduletxt txtreqdateidview form-control input-sm"></h6>

                  <h6 class="aimslabel"><b>Withdrawal #: <input name="wdnumber" value ="<?php if(isset($moduledata)){echo $moduledata['head']['withdrawnum'];}?>" type="text" class="txtwdnumber form-control input-sm" disabled="true"></b></h6>

                  <h6 class="aimslabel"><b>Equipment Release #: <input name="equinumber" value ="<?php if(isset($moduledata)){echo $moduledata['head']['equipreleasenum'];}?>" type="text" class="txtequinumber form-control input-sm" disabled="true"></b></h6>
                  
                  <h6 class="aimslabel"><b>Price type:
                    <select disabled = "true" id="pricetype" class="pricetype input-sm form-control">
                      <?php if(isset($moduledata)){echo '<option>'.$moduledata['head']['pricetype'] . '</option>';}?>
                    </select>
                  </h6>
                  ...
                  <?php
                  if($moduledata['head']['isposted']){
                    echo '<h6 class="aimslabel jb_generatemi" style="display:block;">
                          <button class="btn btn-md btn-flat btn-github"><i class="fa fa-forward"></i> 
                          <b>Generate MI</b></button></h6>';
                    echo '<h6 class="aimslabel jb_generatets" style="display:block;">
                          <button class="btn btn-md btn-flat btn-github"><i class="fa fa-retweet"></i> 
                          <b>Generate TS</b></button></h6>';
                  }else{
                    echo '<h6 class="aimslabel jb_generatemi" style="display:none;">
                          <button class="btn btn-md btn-flat btn-github"><i class="fa fa-forward"></i> 
                          <b>Generate MI</b></button>';
                    echo '<h6 class="aimslabel jb_generatets" style="display:none;">
                          <button class="btn btn-md btn-flat btn-github"><i class="fa fa-retweet"></i> 
                          <b>Generate TS</b></button>';
                  }//end ifs
                  ?>
