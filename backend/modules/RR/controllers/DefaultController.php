...
namespace backend\modules\RR\controllers;
...
class DefaultController extends Controller{
   ...
   public $access = array('view' => 79,'edit' => 80,'new' => 81,'save' => 82,
        'change' => 83,'delete' => 84,'print' => 85,'lock' => 86,
        'unlock' => 87,'post' => 88,'unpost' => 89,'denydetails' => 90,'changeamount' => 91,
        'clickadditem'=>811,'clickedititem'=>812,'clickdeleteitem'=>813);
   ...
   public function actionPulldata(){
      try {
         ...
         $vat = $_GET['vat'];
         $trno = $_GET['trno'];
         $computeddata = Yii::$app->backend->computestock($itemamt,$disc,$isqty,$uomfactor,$this,$vat);
   ...
   public function actionStockdelete(){
        ...
        if($return['verifyuser']==1){
           ...
           return $this->redirect(Url::to(['/admin/default/401']));
            ...
            Yii::$app->response->format = Response::FORMAT_JSON;
            return ['itemcount' => $return['itemcount'],'grandtotal'=>$return['grandtotal'],'forexgrandtotal'=>$return['forexgrandtotal'],'istransposted'=>$return['istransposted']];
            //echo json_encode(array('itemcount' => $return['itemcount'],'grandtotal'=>$return['grandtotal'],'forexgrandtotal'=>$return['forexgrandtotal'],'istransposted'=>$return['istransposted']));
        }                                       
   }
   ...
   public function actionBuildstockview(){
      ...
      return Yii::$app->automator->generateRRStockview($sql,$type);
   }//end function
