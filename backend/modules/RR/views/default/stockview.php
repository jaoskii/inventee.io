...
<div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs bg-green">
              ...
              <li class="pull-right"><h6 class='txtforexgrandtotal' style='display:block;margin-top:12px;margin-right:20px;font-size:12px;font-weight:bold;'>FOREX:  <?php if(isset($moduledata)){echo $moduledata['head']['totalforex']; } ?></li>
