...
<?php if($moduledata['head']['trno'] != null){?>
  ...
  <div class="list">Save All Item</div>
  ...
  <button style="display:none;" disabled="true" type="button" class="pop-btn btn-xx orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i></b></button>
  <div class="list">PO</div>';
  ...
  <div class="list">Quickadd Item</div>
  <button style="display:none;" type="button" class="pop-btn btn-xx orderbtns btn btn-default btn-success stockbtn stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i></b></button>
  <div class="list">PO</div>';
  }
  ?>
...
<!--          <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      <button style="display:none;" disabled="true" type="button" class="orderbtns btn btn-default btn-success stockbtn 
                      stock-btnPO"><b><i class="fa fa-arrow-circle-o-down order_btn"></i> PO</b></button>';

                    }else{
                      echo'<button type="button" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save Stock Items</b></button>
                      <button type="button" class="btn btn-default 
                      btn-success stockbtn stock-btnadd"><b><i class="fa fa-plus add_btn"></i> Add Item
                      </b></button>
                      <button type="button" class="btn btn-default btn-success 
                      stockbtn stock-btnquickadd"><b><i class="fa fa-bolt quickadd_btn"></i> Quick Add</b>
                      </button>
              ...
              <div class="box-body">
                ...
                <?php
                  switch(Yii::$app->systemsettings->companyConfig()) {
                    case 'GAMELINE_POS':
                      echo'<h6 class="aimslabel"><b>Purchase type:
                              <select disabled = "true" id="purchasetype" class="moduletxt purchasetype input-sm form-control">';
                              if(isset($moduledata)){echo '<option>'.$moduledata['head']['purchasetype'] . '</option>';}
                      echo '</select></h6>';
                    break;
                    
                    default:
                      echo'<h6 class="aimslabel" style="display:none;"><b>Purchase type:
                              <select disabled = "true" id="purchasetype" class="moduletxt purchasetype input-sm form-control">';
                      echo '</select></h6>';
                    break;
                  }//end switch
