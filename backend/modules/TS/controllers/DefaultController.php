...
namespace backend\modules\TS\controllers;
...
//THESE ACCESS ARRAY IS USED TO DETERMINE ACCESS INDEX ON ATTRIBUTES
   public $access = array('view' => 309,'edit' => 310,'new' => 311,
        'save' => 312,'change' => 313,'delete' => 314,'print' => 315,
        'lock' => 316,'unlock' => 317,'post' => 318,'unpost' => 319,'changeamount'=>834,
        'clickadditem'=>831,'clickedititem'=>832,'clickdeleteitem'=>833);
...
//FOR SEARCHING FUNCTIONS ###################################################################################
   ...
   public function actionPulldata(){
    ...
    $moduledata["loc2"]= $primarydata[0]["loc2"];
    $moduledata["line"]= 0;
    $moduledata["refx"]= 0;
    $moduledata["linex"]= 0;
    $moduledata["ref"]= '';
   ...
   public function actionComparestocklines(){     
    ...
    public function actionBuildstockview(){
      try {
        ...
        return Yii::$app->automator->generateTSStockview($sql,$type);
