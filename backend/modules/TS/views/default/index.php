...
<button type="button" data-toggle="tooltip" title="New transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnnew"><b><i class="fa fa-file new_btn"></i> </b></button><div class="list">New</div>
                    <button type="button" data-toggle="tooltip" title="Save Transaction Head" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnsave" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save</div>
                     <?php
                      ...
                      echo'<button type="button" data-toggle="tooltip" title="Edit Transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="edit_btn fa fa-pencil"></i> </b></button><div class="list">Edit</div>';
                      }else{
                        if($moduledata['head']['islocked']){
                         echo'<button type="button" data-toggle="tooltip" title="Edit Transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="edit_btn fa fa-pencil"></i> </b></button><div class="list">Edit</div>';
                        }else{
                        echo'<button type="button" data-toggle="tooltip" title="Edit Transaction" class="pop-btn btn-xx btn btn-default btn-success headbtn btnactive module-btnedit" style="display:block;"><b><i class="edit_btn fa fa-pencil"></i> </b></button><div class="list">Edit</div>';
                        }
                      }
                     ?>
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                        ...
                        default:
                          echo '<button  disabled="false" style="display:none;" type="button"  data-toggle="tooltip" title="TR" class="orderbtns pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> </b></button><div class="list">TR</div>';
                        break;
                      }//END SWITCH
                    }else{
                      echo'<button type="button" data-toggle="tooltip" title="Save all  stock Items" class="pop-btn btn-xx btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> </b></button><div class="list">Save Stock Items</div>
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                        ...
                        default:
                          echo '<button style="display:none;" type="button"  data-toggle="tooltip" title="TR" class="orderbtns pop-btn btn-xx btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> </b></button><div class="list">TR</div>';
                        break;
                      }//END SWITCH
                    }
                    ?>
                  ...
                  <?php }else{
                    ...
                    echo '<button disabled="true" id ="'.$moduleid.'-btnnavfirst" type="button" class="btn-navs pop-btn btn-xx btn btn-default btn-success btn-navfirst"><b><i class="fa fa-fast-backward page_nav_icons"></i></b></button>
...
<!--                 <a href="#" class="pull-right" style="font-weight: bold; font-size: 11px; padding: 5px; text-shadow: 1px 0px 1px #ebebe0;">
 ...
 -->          
                ...
                <!-- BEGIN BTN GROUP -->
                  <div class="btn-group">
                    ...
                    <button type="button" data-toggle="tooltip" title="Save Transaction Head" class="btn btn-default btn-success headbtn module-btnsave" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save</b></button>
                     <?php
                      if($moduledata['head']['isposted']){
                      echo'<button type="button" data-toggle="tooltip" title="Edit Transaction" class="btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="edit_btn fa fa-pencil"></i> Edit</b></button>';
                      }else{
                        if($moduledata['head']['islocked']){
                         echo'<button type="button" data-toggle="tooltip" title="Edit Transaction" class="btn btn-default btn-success headbtn module-btnedit" style="display:none;"><b><i class="edit_btn fa fa-pencil"></i> Edit</b></button>';
                        }else{
                        echo'<button type="button" data-toggle="tooltip" title="Edit Transaction" class="btn btn-default btn-success headbtn btnactive module-btnedit" style="display:block;"><b><i class="edit_btn fa fa-pencil"></i> Edit</b></button>';
                        }
                      }
                     ?>
                    ...
                    if($moduledata['head']['islocked'] || $moduledata['head']['isposted']){
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                        ...
                        default:
                          echo '<button  disabled="false" style="display:none;" type="button"  data-toggle="tooltip" title="TR" class="orderbtns btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> TR</b></button>';
                        break;
                      }//end switch
                    }else{
                      echo'<button type="button" data-toggle="tooltip" title="Save all  stock Items" class="btn btn-default btn-success stockbtn stocksaveall" style="display:none;"><b><i class="fa fa-save save_btn"></i> Save Stock Items</b></button>
                      ...
                      switch (Yii::$app->systemsettings->companyConfig()) {
                        ...
                        default:
                          echo '<button style="display:none;" type="button"  data-toggle="tooltip" title="TR" class="orderbtns btn btn-default btn-success stockbtn stock-btnorderlookup"><b><i class="fa fa-tags order_btn"></i> TR</b></button>';
                        break;
                      }//end switch
                    }
                    ?>
              ...
              <div class="box-body">
                ...
                <h6 class="aimslabel clientcodeview" style="display:block;"><b>Destination Code: <input name="clientcodeview" value ="<?php if(isset($moduledata)){echo $moduledata['head']['client'];}?>" type="text" class="txtclientcodeview form-control input-sm" disabled="true"></b></h6>
                <h6 class="aimslabel clientcodelookup" style="display:none;"><b>Destination Code: <div class="input-group"><input name = "client" value ="<?php if(isset($moduledata)){echo $moduledata['head']['client'];}?>"  type="text" class="moduletxt txtclientcode form-control input-sm" disabled="true"></b><div class="clientlookupbtn input-group-addon"><a class ="whclientlookuphead" href="#"><i class="fa fa-chevron-circle-down"></i></a></div>
                </div></h6>
                
                <h6 class="aimslabel"><b>Destination: <input name="clientname" value ="<?php if(isset($moduledata)){echo $moduledata['head']['clientname'];}?>" type="text" class="moduletxt txtclientname form-control input-sm" disabled="true"></b></h6>

                                <!-- WAREHOUSE -->
                <h6 class="aimslabel whcodeview"><b>Source :</b>
                ...
                <h6 class="aimslabel whcodelookup" style="display:none;"><b>Source :</b>
                <div class="input-group">
                ...
                <!-- DATE -->
                 ...
                 <h6 class="aimslabel"><b>Address: <textarea disabled="true" name="addr" class="moduletxt txtclientaddress form-control" style="resize:none;font-size:13px;" rows="2" cols="50"><?php if(isset($moduledata)){echo $moduledata['head']['address'];}?></textarea></b></h6>
                  ...
                  switch (Yii::$app->systemsettings->companyConfig()) {
                    case 'SOUTHCENTRAL':
                      echo '<h6 class="aimslabel"><b>Price Group:
                          <select disabled = "true" id="pricegroup" class="pricegroup input-sm form-control"><option>';
                          if(isset($moduledata)){
                            echo $moduledata['head']['pricegrp'];
                          }//end if
                          echo '</option></select>
                      </h6>

                      <h6 class="aimslabel"><b>Route :
                      <div class="input-group">
                           <input name="route" disabled="true" value ="';
                           if(isset($moduledata)){
                            echo $moduledata['head']['route'];
                            }//end if
                           echo '" type="text" class="moduletxt txtroute form-control input-sm" readonly="true">
                ...
                <?php
                  switch (Yii::$app->systemsettings->companyConfig()) {
                    case 'SOUTHCENTRAL':
                      echo'<h6 class="agentlookup" style="display: none;"><b>Agent:  
                              <div class="input-group">
                                  <input disabled="true" id="clientagentcode" name = "agentcode" readonly="true" value ="';
                                  if(isset($moduledata)){
                                    echo $moduledata['head']['agent'];
                                  }//end if moduledata
                                  echo '" type="text" disabled="true" class="moduletxt txtagentcode input-sm form-control" disabled="true"><div class="frmdocumentno input-group-addon"><a class ="agentlookup" href="#"><i class="fa fa-chevron-circle-down" ></i></a></div>
                              </div>
                          </h6>';
                      echo '<h6 class="agentlookupview"><b>Agent: <input name="agentcodeview" value ="';
                        if(isset($moduledata)){
                          echo $moduledata['head']['agent'];
                        }//end if moduledata
                      echo '" type="text" disabled="true" class="agentlookupview2 input-sm form-control" disabled="true"></b></h6>';                      
                    break;
                  }//END SWITCH CASE
                ?>
