...
?>
          ...
          if(!empty(Yii::$app->session['personallypicked'])){
            echo '<section class="featured-pro container animated">
              <div class="slider-items-products">
                <div class="new_title center">
                  <h2>PERSONALLY PICKED FOR YOU</h2>
                </div>
            ...
            echo '<div class="item" style="margin-bottom:3px;">';
              echo '<div class="col-item">';
                ...
                /*  echo '<div class="actions-links"><span class="add-to-links"> 
                  ...
                  <a title="Add to Compare" id="btncompare-'.$value['barcode'].'" class="btncompare link-compare clickable"><span>Add to Compare</span></a></span> </div>';*/
                echo '</div>';
                echo '<div class="info">';
                  echo '<div class="info-inner">';
                    echo '<div class="item-title">
                    <a title="'.$value['itemname'].'" href="'.Url::to(['/frontend/productdetail/', 'sku' => $value['barcode']]).'">'.$value['itemname'].'</a> </div>';
                    echo '<!--item-title-->';
