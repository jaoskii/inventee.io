...
<div class="modal fade" id="modal-employeelookup" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close btncancelsupp" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Employer Lookup</h4>
      </div>
      <div class="modal-body">
          <label>Search Employer:</label>
          <input type ="hidden" class="clientlookuptype">
          <div class="input-group">
            <input value ="" type="text" class="txtsearchemp input-sm form-control"><div class="frmdocumentno input-group-addon"><i class="fa fa-search"></i></div>
          </div>
          </br>
          ...
          <div class="box box-solid mod-tble">
            ...
            <thead>
              <tr>
                ...
                <th class="col-codes aimslabel">Employer Code</th>
                <th class="col-description aimslabel">Employer Name</th>
              </tr>
            </thead>                               
