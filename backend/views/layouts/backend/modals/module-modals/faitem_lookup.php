...
<div class="modal fade" id="modal-faitemlookup" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="input-group">
          <input value ="" type="text" class="txtsearchfaitem input-sm form-control"><div class="frmdocumentno input-group-addon"><i class="fa fa-search"></i></div>
        </div>
        </br>
            <div class ="box box-solid mod-tble">
              ...
              <thead>
                <tr>
                  ...
                  <th class="col-med aimslabel">Category</th>
                  <th class="col-med aimslabel">Group</th>
                  <th class="col-min aimslabel">UOM</th>
                  <th class="col-currency aimslabel">Amount</th>
                </tr>
              </thead>                                
              <tbody class="tbl-faitemlookup">
              </tbody>
              </table> 
            </div> 
      </div>
      <div class="modal-footer">
        <button type="button" class="faitemchecktaker btn btn-flat btn-success" data-dismiss="modal">OK</button>
      </div>
