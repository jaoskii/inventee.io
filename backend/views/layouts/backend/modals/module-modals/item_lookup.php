            ...
            <div class ="box box-solid mod-tble">
              ...
              <thead>
                <tr>
                  ...
                  <?php if (Yii::$app->systemsettings->companyConfig() == 'UNITEDGLORY') {?>
                  <th class="col-med aimslabel">Size</th>
                  <th class="col-med aimslabel">Brand</th>
                  <th class="col-med aimslabel">Class</th>
                  <th class="col-med aimslabel">Body</th>
                  <?php } ?>
