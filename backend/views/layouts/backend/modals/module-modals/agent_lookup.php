    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="input-group">
            <input value ="" type="text" class="txtsearchagent input-sm form-control"><div class="frmdocumentno input-group-addon"><i class="fa fa-search"></i></div>
          </div>
          </br>
          ...
          <div class="box box-solid mod-tble">
            ...
            <thead>
              <tr>
                ...
                <th class="col-codes aimslabel">Agent Code</th>
                <th class="col-description aimslabel">Agent Name</th>
