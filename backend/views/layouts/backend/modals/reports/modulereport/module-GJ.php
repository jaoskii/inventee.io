...
<div class="modal fade" id="GJmod-report" tabindex="-1" role="dialog" aria-labelledby="GJmod-report" aria-hidden="true" style="z-index: 9999;">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close closereportlogs" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalLabel">Print General Journal</h4>
      </div>

          <form action="<?php echo Url::to(['/reports/default/modulereportgj/']); ?>" method="POST" target="_blank">
