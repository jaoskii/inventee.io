...
<div class="modal fade" id="TXmod-report" tabindex="-1" role="dialog" aria-labelledby="TXmod-report" aria-hidden="true" style="z-index: 9999;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Print</h4>
          ...
          <form action="<?php echo Url::to(['/reports/default/modulereporttx/']); ?>" method="POST" target="_blank">
                <div class="modal-body">
                  ...
                  <input id="report-txkey" name="trno" type="hidden" value="" class="input-sm form-control">
