...
<div class="modal fade" id="RRmod-report" tabindex="-1" role="dialog" aria-labelledby="RRmod-report" aria-hidden="true" style="z-index: 9999;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Print Receiving Report</h4>
          ...
          <form action="<?php echo Url::to(['/reports/default/modulereportrr/']); ?>" method="POST" target="_blank">
