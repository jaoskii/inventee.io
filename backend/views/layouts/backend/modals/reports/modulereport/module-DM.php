...
<div class="modal fade" id="DMmod-report" tabindex="-1" role="dialog" aria-labelledby="DMmod-report" aria-hidden="true" style="z-index: 9999;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Print Purchase Return</h4>
          ...
          <form action="<?php echo Url::to(['/reports/default/modulereportdm/']); ?>" method="POST" target="_blank">
