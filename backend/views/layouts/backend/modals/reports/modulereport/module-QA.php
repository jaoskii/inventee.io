...
<div class="modal fade" id="QAmod-report" tabindex="-1" role="dialog" aria-labelledby="QAmod-report" aria-hidden="true" style="z-index: 9999;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Print Quotation</h4>
          ...
          <form action="<?php echo Url::to(['/reports/default/modulereportqa/']); ?>" method="POST" target="_blank">
                <div class="modal-body">
                  ...
                  switch(Yii::$app->systemsettings->companyConfig()){
                    ...
                    <input type="radio" class="reporttype" name="reporttype" value="warehouse"> SO per Warehouse<br>
                    </div></br>';
                    ...
                    // <label>Option: </label></br>
                    // <input type="radio" class="reporttype" name="reporttype" checked="" value="default"> Default<br>
                    // <input type="radio" class="reporttype" name="reporttype" value="warehouse"> Warehouse<br>
