  ...
  <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="log-btn-mobile">
                <span> <b><i class="new_btn fa fa-gear"></i></b></span>
                <ul class="log-btn-mobile-content">
                  <?php echo '<li><a href = "'. Url::to(['/themer/index/']) .'">Themer</a></li>
...
//          MENU TOGGLER <!-- Sidebar toggle button-->
          echo '<a href="#" style=""class="sidebar-toggle sidemenutoggler" data-toggle="offcanvas" role="button">
              ...
              switch (Yii::$app->systemsettings->companyConfig()) {
                case 'UNIVERSE':
                  echo '<li class="user user-menu">
                    <a href="#">
                      <span class="hidden-xs callquickproductinquiry"><b><i class="fa fa-flash"></i>&nbsp&nbsp QPI</b></span>
                    </a>
                  </li>
                  <li class="user user-menu">
                    <a href="#">
                      <span class="hidden-xs callproductinquiry"><b><i class="fa fa-list"></i>&nbsp&nbsp PI</b></span>
                    </a>
                  </li>';
                break;
              }//END SWITCH
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header" style="height:5%;">
                    ...
                    <p class="user-info"><small><b>Version '.Yii::$app->systemsettings->systemVersion().'</b></small></p>';
                    if(Yii::$app->systemsettings->companyConfig() == 'SBC'){
                      echo '<p class="user-info"><small><b>Current Quota: '.number_format(Yii::$app->systemsettings->quota(),2).'</b></small></p>';
                    }//end if
                  echo '</li>
